...
main(int argc, char *argv[])
{
  ...
  4c:	ff 36                	push   (%esi)
  4e:	e8 af 02 00 00       	call   302 <mkdir>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a0:	0f b6 92 30 07 00 00 	movzbl 0x730(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 46d:	ff 24 85 d8 06 00 00 	jmp    *0x6d8(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 4d2:	75 15                	jne    4e9 <printf+0xfa>
          s = "(null)";
 4d4:	be cf 06 00 00       	mov    $0x6cf,%esi
...
free(void *ap)
{
 ...
 561:	a1 84 0a 00 00       	mov    0xa84,%eax
 ...
 59d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 59f:	a3 84 0a 00 00       	mov    %eax,0xa84
}
 5a4:	5b                   	pop    %ebx
 5a5:	5e                   	pop    %esi
 5a6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 625:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 628:	8b 0d 84 0a 00 00    	mov    0xa84,%ecx
 ...
 634:	eb 4a                	jmp    680 <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
 636:	c7 05 84 0a 00 00 88 	movl   $0xa88,0xa84
 63d:	0a 00 00 
 640:	c7 05 88 0a 00 00 88 	movl   $0xa88,0xa88
 647:	0a 00 00 
    base.s.size = 0;
 64a:	c7 05 8c 0a 00 00 00 	movl   $0x0,0xa8c
 651:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 654:	b9 88 0a 00 00       	mov    $0xa88,%ecx
 ...
 665:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 668:	89 0d 84 0a 00 00    	mov    %ecx,0xa84
      return (void*)(p + 1);
 ...
 685:	73 d4                	jae    65b <malloc+0x46>
    if(p == freep)
 687:	39 05 84 0a 00 00    	cmp    %eax,0xa84
