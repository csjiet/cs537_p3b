...
80103454 <is_same_address_space>:
...
8010345f:	eb 03                	jmp    80103464 <is_same_address_space+0x10>
80103461:	83 e8 80             	sub    $0xffffff80,%eax
80103464:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
80103469:	73 13                	jae    8010347e <is_same_address_space+0x2a>
    if(p != thread && p->pgdir == thread->pgdir){
8010346b:	39 d0                	cmp    %edx,%eax
8010346d:	74 f2                	je     80103461 <is_same_address_space+0xd>
8010346f:	8b 4a 04             	mov    0x4(%edx),%ecx
80103472:	39 48 04             	cmp    %ecx,0x4(%eax)
80103475:	75 ea                	jne    80103461 <is_same_address_space+0xd>
      return 1;
...
80103483:	eb f7                	jmp    8010347c <is_same_address_space+0x28>
...
8010377b:	e8 d4 fc ff ff       	call   80103454 <is_same_address_space>
...
80104e9c:	6a 04                	push   $0x4
80104e9e:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104ea1:	50                   	push   %eax
80104ea2:	6a 00                	push   $0x0
80104ea4:	e8 4a f2 ff ff       	call   801040f3 <argptr>
80104ea9:	83 c4 10             	add    $0x10,%esp
80104eac:	85 c0                	test   %eax,%eax
80104eae:	78 5e                	js     80104f0e <sys_clone+0x78>
80104eb0:	83 ec 04             	sub    $0x4,%esp
80104eb3:	6a 04                	push   $0x4
80104eb5:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104eb8:	50                   	push   %eax
80104eb9:	6a 01                	push   $0x1
80104ebb:	e8 33 f2 ff ff       	call   801040f3 <argptr>
80104ec0:	83 c4 10             	add    $0x10,%esp
80104ec3:	85 c0                	test   %eax,%eax
80104ec5:	78 47                	js     80104f0e <sys_clone+0x78>
80104ec7:	83 ec 04             	sub    $0x4,%esp
80104eca:	6a 04                	push   $0x4
80104ecc:	8d 45 ec             	lea    -0x14(%ebp),%eax
80104ecf:	50                   	push   %eax
80104ed0:	6a 02                	push   $0x2
80104ed2:	e8 1c f2 ff ff       	call   801040f3 <argptr>
80104ed7:	83 c4 10             	add    $0x10,%esp
80104eda:	85 c0                	test   %eax,%eax
80104edc:	78 30                	js     80104f0e <sys_clone+0x78>
80104ede:	83 ec 04             	sub    $0x4,%esp
80104ee1:	68 00 10 00 00       	push   $0x1000
80104ee6:	8d 45 e8             	lea    -0x18(%ebp),%eax
80104ee9:	50                   	push   %eax
80104eea:	6a 03                	push   $0x3
80104eec:	e8 02 f2 ff ff       	call   801040f3 <argptr>
80104ef1:	83 c4 10             	add    $0x10,%esp
80104ef4:	85 c0                	test   %eax,%eax
80104ef6:	78 16                	js     80104f0e <sys_clone+0x78>
    return -1;

  return clone(fcn, arg1, arg2, stackPtr);
80104ef8:	ff 75 e8             	push   -0x18(%ebp)
80104efb:	ff 75 ec             	push   -0x14(%ebp)
80104efe:	ff 75 f0             	push   -0x10(%ebp)
80104f01:	ff 75 f4             	push   -0xc(%ebp)
80104f04:	e8 7d ea ff ff       	call   80103986 <clone>
...
80104f13:	eb f7                	jmp    80104f0c <sys_clone+0x76>
...
80104f1b:	6a 04                	push   $0x4
80104f1d:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104f20:	50                   	push   %eax
80104f21:	6a 00                	push   $0x0
80104f23:	e8 cb f1 ff ff       	call   801040f3 <argptr>
80104f28:	83 c4 10             	add    $0x10,%esp
80104f2b:	85 c0                	test   %eax,%eax
80104f2d:	78 10                	js     80104f3f <sys_join+0x2a>
    return -1;

  return join(stackPtr);
80104f2f:	83 ec 0c             	sub    $0xc,%esp
80104f32:	ff 75 f4             	push   -0xc(%ebp)
80104f35:	e8 6e eb ff ff       	call   80103aa8 <join>
...
80104f3e:	c3                   	ret    
    return -1;
80104f3f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104f44:	eb f7                	jmp    80104f3d <sys_join+0x28>
...
80104f4a:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80104f4d:	68 80 3d 11 80       	push   $0x80113d80
80104f52:	e8 78 ee ff ff       	call   80103dcf <acquire>
  xticks = ticks;
80104f57:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  release(&tickslock);
80104f5d:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
80104f64:	e8 cb ee ff ff       	call   80103e34 <release>
  return xticks;
}
80104f69:	89 d8                	mov    %ebx,%eax
80104f6b:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104f6e:	c9                   	leave  
80104f6f:	c3                   	ret    
