...
worker(void *arg1, void *arg2) {
   ...
   exit();
   6:	e8 7f 04 00 00       	call   48a <exit>
...
0000000b <main>:
{
  ...
  52:	e8 d3 04 00 00       	call   52a <clone>
  ...
  6f:	6a 01                	push   $0x1
  71:	e8 69 05 00 00       	call   5df <printf>
  76:	83 c4 0c             	add    $0xc,%esp
  79:	68 f0 08 00 00       	push   $0x8f0
  7e:	68 a7 08 00 00       	push   $0x8a7
  83:	6a 01                	push   $0x1
  85:	e8 55 05 00 00       	call   5df <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 590:	0f b6 92 9c 09 00 00 	movzbl 0x99c(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 65d:	ff 24 85 44 09 00 00 	jmp    *0x944(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 6c2:	75 15                	jne    6d9 <printf+0xfa>
          s = "(null)";
 6c4:	be 3c 09 00 00       	mov    $0x93c,%esi
...
free(void *ap)
{
 ...
 751:	a1 0c 0d 00 00       	mov    0xd0c,%eax
 ...
 78d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 78f:	a3 0c 0d 00 00       	mov    %eax,0xd0c
}
 794:	5b                   	pop    %ebx
 795:	5e                   	pop    %esi
 796:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 7ec:	e8 54 ff ff ff       	call   745 <free>
  return freep;
 7f1:	a1 0c 0d 00 00       	mov    0xd0c,%eax
...
malloc(uint nbytes)
{
 ...
 815:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 818:	8b 0d 0c 0d 00 00    	mov    0xd0c,%ecx
 ...
 824:	eb 4a                	jmp    870 <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
 826:	c7 05 0c 0d 00 00 10 	movl   $0xd10,0xd0c
 82d:	0d 00 00 
 830:	c7 05 10 0d 00 00 10 	movl   $0xd10,0xd10
 837:	0d 00 00 
    base.s.size = 0;
 83a:	c7 05 14 0d 00 00 00 	movl   $0x0,0xd14
 841:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 844:	b9 10 0d 00 00       	mov    $0xd10,%ecx
 ...
 855:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 858:	89 0d 0c 0d 00 00    	mov    %ecx,0xd0c
      return (void*)(p + 1);
 ...
 875:	73 d4                	jae    84b <malloc+0x46>
    if(p == freep)
 877:	39 05 0c 0d 00 00    	cmp    %eax,0xd0c
