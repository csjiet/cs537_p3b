...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
      ...
      11:	e8 df 38 00 00       	call   38f5 <printf>

  if(mkdir("iputdir") < 0){
      16:	c7 04 24 cb 3b 00 00 	movl   $0x3bcb,(%esp)
      1d:	e8 e6 37 00 00       	call   3808 <mkdir>
  ...
  if(chdir("iputdir") < 0){
      ...
      31:	e8 da 37 00 00       	call   3810 <chdir>
  ...
  if(unlink("../iputdir") < 0){
      ...
      45:	e8 a6 37 00 00       	call   37f0 <unlink>
  ...
  if(chdir("/") < 0){
      ...
      59:	e8 b2 37 00 00       	call   3810 <chdir>
  ...
  printf(stdout, "iput test ok\n");
      ...
      73:	e8 7d 38 00 00       	call   38f5 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
      ...
      8b:	e8 65 38 00 00       	call   38f5 <printf>
    exit();
      90:	e8 0b 37 00 00       	call   37a0 <exit>
    printf(stdout, "chdir iputdir failed\n");
      95:	83 ec 08             	sub    $0x8,%esp
      98:	68 b2 3b 00 00       	push   $0x3bb2
      9d:	ff 35 d4 5c 00 00    	push   0x5cd4
      a3:	e8 4d 38 00 00       	call   38f5 <printf>
    exit();
      a8:	e8 f3 36 00 00       	call   37a0 <exit>
    printf(stdout, "unlink ../iputdir failed\n");
      ad:	83 ec 08             	sub    $0x8,%esp
      b0:	68 d3 3b 00 00       	push   $0x3bd3
      b5:	ff 35 d4 5c 00 00    	push   0x5cd4
      bb:	e8 35 38 00 00       	call   38f5 <printf>
    exit();
      c0:	e8 db 36 00 00       	call   37a0 <exit>
    printf(stdout, "chdir / failed\n");
      c5:	83 ec 08             	sub    $0x8,%esp
      c8:	68 ef 3b 00 00       	push   $0x3bef
      cd:	ff 35 d4 5c 00 00    	push   0x5cd4
      d3:	e8 1d 38 00 00       	call   38f5 <printf>
    exit();
      d8:	e8 c3 36 00 00       	call   37a0 <exit>
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      ...
      ee:	e8 02 38 00 00       	call   38f5 <printf>

  pid = fork();
      f3:	e8 a0 36 00 00       	call   3798 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     10d:	e8 f6 36 00 00       	call   3808 <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     121:	e8 ea 36 00 00       	call   3810 <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     135:	e8 b6 36 00 00       	call   37f0 <unlink>
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     ...
     1d4:	e8 1c 37 00 00       	call   38f5 <printf>
  if(mkdir("oidir") < 0){
     1d9:	c7 04 24 43 3c 00 00 	movl   $0x3c43,(%esp)
     1e0:	e8 23 36 00 00       	call   3808 <mkdir>
  ...
  pid = fork();
     1ec:	e8 a7 35 00 00       	call   3798 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     201:	e8 da 35 00 00       	call   37e0 <open>
    if(fd >= 0){
     ...
     21b:	e8 d5 36 00 00       	call   38f5 <printf>
      exit();
     220:	e8 7b 35 00 00       	call   37a0 <exit>
    printf(stdout, "mkdir oidir failed\n");
     225:	83 ec 08             	sub    $0x8,%esp
     228:	68 49 3c 00 00       	push   $0x3c49
     22d:	ff 35 d4 5c 00 00    	push   0x5cd4
     233:	e8 bd 36 00 00       	call   38f5 <printf>
    exit();
     238:	e8 63 35 00 00       	call   37a0 <exit>
    printf(stdout, "fork failed\n");
     23d:	83 ec 08             	sub    $0x8,%esp
     240:	68 e5 4a 00 00       	push   $0x4ae5
     245:	ff 35 d4 5c 00 00    	push   0x5cd4
     24b:	e8 a5 36 00 00       	call   38f5 <printf>
    exit();
     250:	e8 4b 35 00 00       	call   37a0 <exit>
    }
    exit();
     255:	e8 46 35 00 00       	call   37a0 <exit>
  }
  sleep(1);
     25a:	83 ec 0c             	sub    $0xc,%esp
     25d:	6a 01                	push   $0x1
     25f:	e8 cc 35 00 00       	call   3830 <sleep>
  if(unlink("oidir") != 0){
     264:	c7 04 24 43 3c 00 00 	movl   $0x3c43,(%esp)
     26b:	e8 80 35 00 00       	call   37f0 <unlink>
  ...
  printf(stdout, "openiput test ok\n");
    ...
    printf(stdout, "unlink failed\n");
     ...
     2a2:	e8 4e 36 00 00       	call   38f5 <printf>
    exit();
     2a7:	e8 f4 34 00 00       	call   37a0 <exit>
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     ...
     2bd:	e8 33 36 00 00       	call   38f5 <printf>
  fd = open("echo", 0);
     2c2:	83 c4 08             	add    $0x8,%esp
     2c5:	6a 00                	push   $0x0
     2c7:	68 89 3c 00 00       	push   $0x3c89
     2cc:	e8 0f 35 00 00       	call   37e0 <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     2db:	50                   	push   %eax
     2dc:	e8 e7 34 00 00       	call   37c8 <close>
  fd = open("doesnotexist", 0);
     2e1:	83 c4 08             	add    $0x8,%esp
     2e4:	6a 00                	push   $0x0
     2e6:	68 a1 3c 00 00       	push   $0x3ca1
     2eb:	e8 f0 34 00 00       	call   37e0 <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
     ...
     305:	e8 eb 35 00 00       	call   38f5 <printf>
}
    ...
    printf(stdout, "open echo failed!\n");
     ...
     31d:	e8 d3 35 00 00       	call   38f5 <printf>
    exit();
     322:	e8 79 34 00 00       	call   37a0 <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     327:	83 ec 08             	sub    $0x8,%esp
     32a:	68 ae 3c 00 00       	push   $0x3cae
     32f:	ff 35 d4 5c 00 00    	push   0x5cd4
     335:	e8 bb 35 00 00       	call   38f5 <printf>
    exit();
     33a:	e8 61 34 00 00       	call   37a0 <exit>
...
writetest(void)
{
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     380:	e8 70 35 00 00       	call   38f5 <printf>
  } else {
  ...
  for(i = 0; i < 100; i++){
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     39c:	56                   	push   %esi
     39d:	e8 1e 34 00 00       	call   37c0 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     3b4:	56                   	push   %esi
     3b5:	e8 06 34 00 00       	call   37c0 <write>
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     3d5:	e8 1b 35 00 00       	call   38f5 <printf>
    exit();
     3da:	e8 c1 33 00 00       	call   37a0 <exit>
      printf(stdout, "error: write aa %d new file failed\n", i);
     3df:	83 ec 04             	sub    $0x4,%esp
     3e2:	53                   	push   %ebx
     3e3:	68 ec 4b 00 00       	push   $0x4bec
     3e8:	ff 35 d4 5c 00 00    	push   0x5cd4
     3ee:	e8 02 35 00 00       	call   38f5 <printf>
      exit();
     3f3:	e8 a8 33 00 00       	call   37a0 <exit>
      printf(stdout, "error: write bb %d new file failed\n", i);
     3f8:	83 ec 04             	sub    $0x4,%esp
     3fb:	53                   	push   %ebx
     3fc:	68 10 4c 00 00       	push   $0x4c10
     401:	ff 35 d4 5c 00 00    	push   0x5cd4
     407:	e8 e9 34 00 00       	call   38f5 <printf>
      exit();
     40c:	e8 8f 33 00 00       	call   37a0 <exit>
    }
  }
  printf(stdout, "writes ok\n");
     ...
     41f:	e8 d1 34 00 00       	call   38f5 <printf>
  close(fd);
     424:	89 34 24             	mov    %esi,(%esp)
     427:	e8 9c 33 00 00       	call   37c8 <close>
  fd = open("small", O_RDONLY);
     42c:	83 c4 08             	add    $0x8,%esp
     42f:	6a 00                	push   $0x0
     431:	68 eb 3c 00 00       	push   $0x3ceb
     436:	e8 a5 33 00 00       	call   37e0 <open>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     452:	e8 9e 34 00 00       	call   38f5 <printf>
  } else {
  ...
  i = read(fd, buf, 2000);
     ...
     464:	53                   	push   %ebx
     465:	e8 4e 33 00 00       	call   37b8 <read>
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     482:	e8 6e 34 00 00       	call   38f5 <printf>
  } else {
  ...
  close(fd);
     ...
     48a:	e8 39 33 00 00       	call   37c8 <close>

  if(unlink("small") < 0){
     48f:	c7 04 24 eb 3c 00 00 	movl   $0x3ceb,(%esp)
     496:	e8 55 33 00 00       	call   37f0 <unlink>
  ...
  printf(stdout, "small file test ok\n");
     ...
     4b0:	e8 40 34 00 00       	call   38f5 <printf>
}
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     4cd:	e8 23 34 00 00       	call   38f5 <printf>
    exit();
     4d2:	e8 c9 32 00 00       	call   37a0 <exit>
    printf(stdout, "read failed\n");
     4d7:	83 ec 08             	sub    $0x8,%esp
     4da:	68 a9 40 00 00       	push   $0x40a9
     4df:	ff 35 d4 5c 00 00    	push   0x5cd4
     4e5:	e8 0b 34 00 00       	call   38f5 <printf>
    exit();
     4ea:	e8 b1 32 00 00       	call   37a0 <exit>
    printf(stdout, "unlink small failed\n");
     4ef:	83 ec 08             	sub    $0x8,%esp
     4f2:	68 90 3d 00 00       	push   $0x3d90
     4f7:	ff 35 d4 5c 00 00    	push   0x5cd4
     4fd:	e8 f3 33 00 00       	call   38f5 <printf>
    exit();
     502:	e8 99 32 00 00       	call   37a0 <exit>
...
writetest1(void)
{
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     55a:	56                   	push   %esi
     55b:	e8 60 32 00 00       	call   37c0 <write>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     57d:	e8 73 33 00 00       	call   38f5 <printf>
    exit();
     582:	e8 19 32 00 00       	call   37a0 <exit>
      printf(stdout, "error: write big file failed\n", i);
     587:	83 ec 04             	sub    $0x4,%esp
     58a:	53                   	push   %ebx
     58b:	68 e3 3d 00 00       	push   $0x3de3
     590:	ff 35 d4 5c 00 00    	push   0x5cd4
     596:	e8 5a 33 00 00       	call   38f5 <printf>
      exit();
     59b:	e8 00 32 00 00       	call   37a0 <exit>
    }
  }
  ...
  close(fd);
     ...
     5a3:	56                   	push   %esi
     5a4:	e8 1f 32 00 00       	call   37c8 <close>

  fd = open("big", O_RDONLY);
     5a9:	83 c4 08             	add    $0x8,%esp
     5ac:	6a 00                	push   $0x0
     5ae:	68 33 3e 00 00       	push   $0x3e33
     5b3:	e8 28 32 00 00       	call   37e0 <open>
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     5d3:	56                   	push   %esi
     5d4:	e8 df 31 00 00       	call   37b8 <read>
    if(i == 0){
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     60b:	e8 e5 32 00 00       	call   38f5 <printf>
    exit();
     610:	e8 8b 31 00 00       	call   37a0 <exit>
      if(n == MAXFILE - 1){
  ...
  close(fd);
     ...
     620:	56                   	push   %esi
     621:	e8 a2 31 00 00       	call   37c8 <close>
  if(unlink("big") < 0){
     626:	c7 04 24 33 3e 00 00 	movl   $0x3e33,(%esp)
     62d:	e8 be 31 00 00       	call   37f0 <unlink>
  ...
  printf(stdout, "big files ok\n");
     ...
     647:	e8 a9 32 00 00       	call   38f5 <printf>
}
     ...
     665:	e8 8b 32 00 00       	call   38f5 <printf>
        exit();
     66a:	e8 31 31 00 00       	call   37a0 <exit>
      printf(stdout, "read failed %d\n", i);
     66f:	83 ec 04             	sub    $0x4,%esp
     672:	50                   	push   %eax
     673:	68 37 3e 00 00       	push   $0x3e37
     678:	ff 35 d4 5c 00 00    	push   0x5cd4
     67e:	e8 72 32 00 00       	call   38f5 <printf>
      exit();
     683:	e8 18 31 00 00       	call   37a0 <exit>
      printf(stdout, "read content of block %d is %d\n",
     688:	50                   	push   %eax
     689:	53                   	push   %ebx
     68a:	68 34 4c 00 00       	push   $0x4c34
     68f:	ff 35 d4 5c 00 00    	push   0x5cd4
     695:	e8 5b 32 00 00       	call   38f5 <printf>
      exit();
     69a:	e8 01 31 00 00       	call   37a0 <exit>
    printf(stdout, "unlink big failed\n");
     69f:	83 ec 08             	sub    $0x8,%esp
     6a2:	68 47 3e 00 00       	push   $0x3e47
     6a7:	ff 35 d4 5c 00 00    	push   0x5cd4
     6ad:	e8 43 32 00 00       	call   38f5 <printf>
    exit();
     6b2:	e8 e9 30 00 00       	call   37a0 <exit>
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     6c9:	e8 27 32 00 00       	call   38f5 <printf>
  ...
  for(i = 0; i < 52; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     6fb:	e8 e0 30 00 00       	call   37e0 <open>
    close(fd);
     700:	89 04 24             	mov    %eax,(%esp)
     703:	e8 c0 30 00 00       	call   37c8 <close>
  for(i = 0; i < 52; i++){
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     738:	e8 b3 30 00 00       	call   37f0 <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     756:	e8 9a 31 00 00       	call   38f5 <printf>
}
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     774:	e8 7c 31 00 00       	call   38f5 <printf>

  if(mkdir("dir0") < 0){
     779:	c7 04 24 74 3e 00 00 	movl   $0x3e74,(%esp)
     780:	e8 83 30 00 00       	call   3808 <mkdir>
  ...
  if(chdir("dir0") < 0){
     ...
     794:	e8 77 30 00 00       	call   3810 <chdir>
  ...
  if(chdir("..") < 0){
     ...
     7a8:	e8 63 30 00 00       	call   3810 <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     7bc:	e8 2f 30 00 00       	call   37f0 <unlink>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     7d6:	e8 1a 31 00 00       	call   38f5 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     ...
     7ee:	e8 02 31 00 00       	call   38f5 <printf>
    exit();
     7f3:	e8 a8 2f 00 00       	call   37a0 <exit>
    printf(stdout, "chdir dir0 failed\n");
     7f8:	83 ec 08             	sub    $0x8,%esp
     7fb:	68 79 3e 00 00       	push   $0x3e79
     800:	ff 35 d4 5c 00 00    	push   0x5cd4
     806:	e8 ea 30 00 00       	call   38f5 <printf>
    exit();
     80b:	e8 90 2f 00 00       	call   37a0 <exit>
    printf(stdout, "chdir .. failed\n");
     810:	83 ec 08             	sub    $0x8,%esp
     813:	68 8c 3e 00 00       	push   $0x3e8c
     818:	ff 35 d4 5c 00 00    	push   0x5cd4
     81e:	e8 d2 30 00 00       	call   38f5 <printf>
    exit();
     823:	e8 78 2f 00 00       	call   37a0 <exit>
    printf(stdout, "unlink dir0 failed\n");
     828:	83 ec 08             	sub    $0x8,%esp
     82b:	68 9d 3e 00 00       	push   $0x3e9d
     830:	ff 35 d4 5c 00 00    	push   0x5cd4
     836:	e8 ba 30 00 00       	call   38f5 <printf>
    exit();
     83b:	e8 60 2f 00 00       	call   37a0 <exit>
...
exectest(void)
{
  ...
  if(exec("echo", echoargv) < 0){
    ...
    printf(stdout, "exec echo failed\n");
     ...
     87f:	e8 71 30 00 00       	call   38f5 <printf>
    exit();
     884:	e8 17 2f 00 00       	call   37a0 <exit>
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
     ...
     895:	50                   	push   %eax
     896:	e8 15 2f 00 00       	call   37b0 <pipe>
  ...
  pid = fork();
     8a4:	e8 ef 2e 00 00       	call   3798 <fork>
  ...
  if(pid == 0){
    ...
    close(fds[1]);
     ...
     8bb:	e8 08 2f 00 00       	call   37c8 <close>
    total = 0;
    cc = 1;
  ...
  seq = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     8dd:	e8 d6 2e 00 00       	call   37b8 <read>
    ...
    printf(1, "pipe() failed\n");
     ...
     91e:	6a 01                	push   $0x1
     920:	e8 d0 2f 00 00       	call   38f5 <printf>
    exit();
     925:	e8 76 2e 00 00       	call   37a0 <exit>
    close(fds[0]);
     92a:	83 ec 0c             	sub    $0xc,%esp
     92d:	ff 75 e0             	push   -0x20(%ebp)
     930:	e8 93 2e 00 00       	call   37c8 <close>
    for(n = 0; n < 5; n++){
  ...
  seq = 0;
    ...
    for(n = 0; n < 5; n++){
     ...
     961:	e8 5a 2e 00 00       	call   37c0 <write>
    ...
    for(n = 0; n < 5; n++){
     ...
     984:	6a 01                	push   $0x1
     986:	e8 6a 2f 00 00       	call   38f5 <printf>
        exit();
     98b:	e8 10 2e 00 00       	call   37a0 <exit>
    exit();
     990:	e8 0b 2e 00 00       	call   37a0 <exit>
          printf(1, "pipe1 oops 2\n");
     995:	83 ec 08             	sub    $0x8,%esp
     998:	68 fa 3e 00 00       	push   $0x3efa
     99d:	6a 01                	push   $0x1
     99f:	e8 51 2f 00 00       	call   38f5 <printf>
          return;
  ...
  printf(1, "pipe1 ok\n");
    ...
    close(fds[0]);
     ...
     9e0:	e8 e3 2d 00 00       	call   37c8 <close>
    wait();
     9e5:	e8 be 2d 00 00       	call   37a8 <wait>
  printf(1, "pipe1 ok\n");
     9ea:	83 c4 08             	add    $0x8,%esp
     9ed:	68 1f 3f 00 00       	push   $0x3f1f
     9f2:	6a 01                	push   $0x1
     9f4:	e8 fc 2e 00 00       	call   38f5 <printf>
     ...
     a09:	6a 01                	push   $0x1
     a0b:	e8 e5 2e 00 00       	call   38f5 <printf>
      exit();
     a10:	e8 8b 2d 00 00       	call   37a0 <exit>
    printf(1, "fork() failed\n");
     a15:	83 ec 08             	sub    $0x8,%esp
     a18:	68 29 3f 00 00       	push   $0x3f29
     a1d:	6a 01                	push   $0x1
     a1f:	e8 d1 2e 00 00       	call   38f5 <printf>
    exit();
     a24:	e8 77 2d 00 00       	call   37a0 <exit>
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     ...
     a37:	6a 01                	push   $0x1
     a39:	e8 b7 2e 00 00       	call   38f5 <printf>
  pid1 = fork();
     a3e:	e8 55 2d 00 00       	call   3798 <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     a4e:	e8 45 2d 00 00       	call   3798 <fork>
  ...
  pipe(pfds);
     ...
     a61:	50                   	push   %eax
     a62:	e8 49 2d 00 00       	call   37b0 <pipe>
  pid3 = fork();
     a67:	e8 2c 2d 00 00       	call   3798 <fork>
  ...
  if(pid3 == 0){
    ...
    close(pfds[1]);
     ...
     aa0:	e8 23 2d 00 00       	call   37c8 <close>
    ...
    for(;;)
     ...
     ab2:	6a 01                	push   $0x1
     ab4:	e8 3c 2e 00 00       	call   38f5 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     ...
     aee:	6a 01                	push   $0x1
     af0:	e8 00 2e 00 00       	call   38f5 <printf>
    return;
  ...
  close(pfds[0]);
     ...
     b06:	e8 bd 2c 00 00       	call   37c8 <close>
  printf(1, "kill... ");
     b0b:	83 c4 08             	add    $0x8,%esp
     b0e:	68 69 3f 00 00       	push   $0x3f69
     b13:	6a 01                	push   $0x1
     b15:	e8 db 2d 00 00       	call   38f5 <printf>
  kill(pid1);
     b1a:	89 1c 24             	mov    %ebx,(%esp)
     b1d:	e8 ae 2c 00 00       	call   37d0 <kill>
  kill(pid2);
     b22:	89 34 24             	mov    %esi,(%esp)
     b25:	e8 a6 2c 00 00       	call   37d0 <kill>
  kill(pid3);
     b2a:	89 3c 24             	mov    %edi,(%esp)
     b2d:	e8 9e 2c 00 00       	call   37d0 <kill>
  printf(1, "wait... ");
     b32:	83 c4 08             	add    $0x8,%esp
     b35:	68 72 3f 00 00       	push   $0x3f72
     b3a:	6a 01                	push   $0x1
     b3c:	e8 b4 2d 00 00       	call   38f5 <printf>
  wait();
     b41:	e8 62 2c 00 00       	call   37a8 <wait>
  wait();
     b46:	e8 5d 2c 00 00       	call   37a8 <wait>
  wait();
     b4b:	e8 58 2c 00 00       	call   37a8 <wait>
  printf(1, "preempt ok\n");
     b50:	83 c4 08             	add    $0x8,%esp
     b53:	68 7b 3f 00 00       	push   $0x3f7b
     b58:	6a 01                	push   $0x1
     b5a:	e8 96 2d 00 00       	call   38f5 <printf>
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     b73:	e8 20 2c 00 00       	call   3798 <fork>
    ...
    if(pid){
     b7e:	74 3b                	je     bbb <exitwait+0x57>
      if(wait() != pid){
     b80:	e8 23 2c 00 00       	call   37a8 <wait>
  ...
  for(i = 0; i < 100; i++){
     ...
     b96:	6a 01                	push   $0x1
     b98:	e8 58 2d 00 00       	call   38f5 <printf>
      return;
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     ...
     be2:	6a 01                	push   $0x1
     be4:	e8 0c 2d 00 00       	call   38f5 <printf>
  ppid = getpid();
     be9:	e8 32 2c 00 00       	call   3820 <getpid>
     bee:	89 c6                	mov    %eax,%esi
  if((pid = fork()) == 0){
     bf0:	e8 a3 2b 00 00       	call   3798 <fork>
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     c13:	e8 03 2f 00 00       	call   3b1b <malloc>
    ...
    while(m1){
     ...
     c26:	53                   	push   %ebx
     c27:	e8 2f 2e 00 00       	call   3a5b <free>
    ...
    m1 = malloc(1024*20);
     ...
     c3d:	e8 d9 2e 00 00       	call   3b1b <malloc>
    if(m1 == 0){
    ...
    free(m1);
     ...
     c4c:	50                   	push   %eax
     c4d:	e8 09 2e 00 00       	call   3a5b <free>
    printf(1, "mem ok\n");
     c52:	83 c4 08             	add    $0x8,%esp
     c55:	68 c8 3f 00 00       	push   $0x3fc8
     c5a:	6a 01                	push   $0x1
     c5c:	e8 94 2c 00 00       	call   38f5 <printf>
    exit();
     c61:	e8 3a 2b 00 00       	call   37a0 <exit>
      printf(1, "couldn't allocate mem?!!\n");
     c66:	83 ec 08             	sub    $0x8,%esp
     c69:	68 ae 3f 00 00       	push   $0x3fae
     c6e:	6a 01                	push   $0x1
     c70:	e8 80 2c 00 00       	call   38f5 <printf>
      kill(ppid);
     c75:	89 34 24             	mov    %esi,(%esp)
     c78:	e8 53 2b 00 00       	call   37d0 <kill>
      exit();
     c7d:	e8 1e 2b 00 00       	call   37a0 <exit>
  } else {
    wait();
     c82:	e8 21 2b 00 00       	call   37a8 <wait>
  }
}
...
sharedfd(void)
{
  ...
  pid = fork();
     ccb:	e8 c8 2a 00 00       	call   3798 <fork>
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     d02:	50                   	push   %eax
     d03:	56                   	push   %esi
     d04:	e8 b7 2a 00 00       	call   37c0 <write>
  ...
  for(i = 0; i < 1000; i++){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     d1e:	6a 01                	push   $0x1
     d20:	e8 d0 2b 00 00       	call   38f5 <printf>
    return;
  ...
  memset(buf, pid==0?'c':'p', sizeof(buf));
     ...
     d3c:	6a 01                	push   $0x1
     d3e:	e8 b2 2b 00 00       	call   38f5 <printf>
      break;
  ...
  if(pid == 0)
    ...
    wait();
     d4a:	e8 59 2a 00 00       	call   37a8 <wait>
  close(fd);
     d4f:	83 ec 0c             	sub    $0xc,%esp
     d52:	56                   	push   %esi
     d53:	e8 70 2a 00 00       	call   37c8 <close>
  fd = open("sharedfd", 0);
     d58:	83 c4 08             	add    $0x8,%esp
     d5b:	6a 00                	push   $0x0
     d5d:	68 df 3f 00 00       	push   $0x3fdf
     d62:	e8 79 2a 00 00       	call   37e0 <open>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     d82:	50                   	push   %eax
     d83:	57                   	push   %edi
     d84:	e8 2f 2a 00 00       	call   37b8 <read>
    ...
    exit();
     d97:	e8 04 2a 00 00       	call   37a0 <exit>
    printf(1, "fstests: cannot open sharedfd for reading\n");
     d9c:	83 ec 08             	sub    $0x8,%esp
     d9f:	68 f0 4c 00 00       	push   $0x4cf0
     da4:	6a 01                	push   $0x1
     da6:	e8 4a 2b 00 00       	call   38f5 <printf>
    return;
  ...
  close(fd);
     ...
     dd4:	57                   	push   %edi
     dd5:	e8 ee 29 00 00       	call   37c8 <close>
  unlink("sharedfd");
     dda:	c7 04 24 df 3f 00 00 	movl   $0x3fdf,(%esp)
     de1:	e8 0a 2a 00 00       	call   37f0 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     e07:	6a 01                	push   $0x1
     e09:	e8 e7 2a 00 00       	call   38f5 <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     e20:	6a 01                	push   $0x1
     e22:	e8 ce 2a 00 00       	call   38f5 <printf>
    exit();
     e27:	e8 74 29 00 00       	call   37a0 <exit>
...
fourfiles(void)
{
  ...
  printf(1, "fourfiles test\n");
     ...
     e56:	6a 01                	push   $0x1
     e58:	e8 98 2a 00 00       	call   38f5 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    if(pid < 0){
     ...
     e6f:	6a 01                	push   $0x1
     e71:	e8 7f 2a 00 00       	call   38f5 <printf>
      exit();
     e76:	e8 25 29 00 00       	call   37a0 <exit>
    }
    ...
    if(pid == 0){
     ...
     e83:	6a 01                	push   $0x1
     e85:	e8 6b 2a 00 00       	call   38f5 <printf>
        exit();
     e8a:	e8 11 29 00 00       	call   37a0 <exit>
      }
     ...
     e98:	6a 01                	push   $0x1
     e9a:	e8 56 2a 00 00       	call   38f5 <printf>
          exit();
     e9f:	e8 fc 28 00 00       	call   37a0 <exit>
        }
      }
      exit();
     ea4:	e8 f7 28 00 00       	call   37a0 <exit>
  for(pi = 0; pi < 4; pi++){
    ...
    unlink(fname);
     ...
     eb8:	57                   	push   %edi
     eb9:	e8 32 29 00 00       	call   37f0 <unlink>
    pid = fork();
     ebe:	e8 d5 28 00 00       	call   3798 <fork>
    if(pid < 0){
    ...
    if(pid == 0){
     ...
     ed6:	57                   	push   %edi
     ed7:	e8 04 29 00 00       	call   37e0 <open>
     ...
     f10:	57                   	push   %edi
     f11:	e8 aa 28 00 00       	call   37c0 <write>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
     f30:	e8 73 28 00 00       	call   37a8 <wait>
  for(pi = 0; pi < 4; pi++){
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	6a 01                	push   $0x1
     f4e:	e8 a2 29 00 00       	call   38f5 <printf>
          exit();
     f53:	e8 48 28 00 00       	call   37a0 <exit>
        }
      }
      total += n;
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f68:	56                   	push   %esi
     f69:	e8 4a 28 00 00       	call   37b8 <read>
    ...
    close(fd);
     ...
     f96:	56                   	push   %esi
     f97:	e8 2c 28 00 00       	call   37c8 <close>
    if(total != 12*500){
    ...
    unlink(fname);
     ...
     fae:	e8 3d 28 00 00       	call   37f0 <unlink>
  for(i = 0; i < 2; i++){
    ...
    fd = open(fname, 0);
     ...
     fc8:	6a 00                	push   $0x0
     fca:	50                   	push   %eax
     fcb:	e8 10 28 00 00       	call   37e0 <open>
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     fec:	6a 01                	push   $0x1
     fee:	e8 02 29 00 00       	call   38f5 <printf>
      exit();
     ff3:	e8 a8 27 00 00       	call   37a0 <exit>
  }
  ...
  printf(1, "fourfiles ok\n");
    ...
    1000:	6a 01                	push   $0x1
    1002:	e8 ee 28 00 00       	call   38f5 <printf>
}
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    ...
    101f:	6a 01                	push   $0x1
    1021:	e8 cf 28 00 00       	call   38f5 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    pid = fork();
    1037:	e8 5c 27 00 00       	call   3798 <fork>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1051:	6a 01                	push   $0x1
    1053:	e8 9d 28 00 00       	call   38f5 <printf>
      exit();
    1058:	e8 43 27 00 00       	call   37a0 <exit>
      name[0] = 'p' + pi;
    ...
    1071:	6a 01                	push   $0x1
    1073:	e8 7d 28 00 00       	call   38f5 <printf>
          exit();
    1078:	e8 23 27 00 00       	call   37a0 <exit>
      for(i = 0; i < N; i++){
    ...
    1096:	50                   	push   %eax
    1097:	e8 44 27 00 00       	call   37e0 <open>
        if(fd < 0){
    ...
    10a6:	50                   	push   %eax
    10a7:	e8 1c 27 00 00       	call   37c8 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    10cd:	50                   	push   %eax
    10ce:	e8 1d 27 00 00       	call   37f0 <unlink>
    ...
    10e2:	6a 01                	push   $0x1
    10e4:	e8 0c 28 00 00       	call   38f5 <printf>
            exit();
    10e9:	e8 b2 26 00 00       	call   37a0 <exit>
          }
        }
      }
      exit();
    10ee:	e8 ad 26 00 00       	call   37a0 <exit>
    }
  }
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    10fa:	e8 a9 26 00 00       	call   37a8 <wait>
  for(pi = 0; pi < 4; pi++){
  ...
  for(i = 0; i < N; i++){
    ...
    1145:	50                   	push   %eax
    1146:	e8 95 26 00 00       	call   37e0 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    116d:	6a 01                	push   $0x1
    116f:	e8 81 27 00 00       	call   38f5 <printf>
        exit();
    1174:	e8 27 26 00 00       	call   37a0 <exit>
      } else if((i >= 1 && i < N/2) && fd >= 0){
    ...
    1189:	6a 01                	push   $0x1
    118b:	e8 65 27 00 00       	call   38f5 <printf>
        exit();
    1190:	e8 0b 26 00 00       	call   37a0 <exit>
        close(fd);
    1195:	83 ec 0c             	sub    $0xc,%esp
    1198:	50                   	push   %eax
    1199:	e8 2a 26 00 00       	call   37c8 <close>
  ...
  for(i = 0; i < N; i++){
    ...
    11ce:	50                   	push   %eax
    11cf:	e8 1c 26 00 00       	call   37f0 <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    11f6:	6a 01                	push   $0x1
    11f8:	e8 f8 26 00 00       	call   38f5 <printf>
}
...
unlinkread(void)
{
  ...
  write(fd, "hello", 5);
    ...
    1244:	50                   	push   %eax
    1245:	e8 76 25 00 00       	call   37c0 <write>
  close(fd);
    124a:	89 1c 24             	mov    %ebx,(%esp)
    124d:	e8 76 25 00 00       	call   37c8 <close>

  fd = open("unlinkread", O_RDWR);
    1252:	83 c4 08             	add    $0x8,%esp
    1255:	6a 02                	push   $0x2
    1257:	68 91 40 00 00       	push   $0x4091
    125c:	e8 7f 25 00 00       	call   37e0 <open>
  ...
  if(unlink("unlinkread") != 0){
    ...
    1276:	e8 75 25 00 00       	call   37f0 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1293:	e8 48 25 00 00       	call   37e0 <open>
  ...
  write(fd1, "yyy", 3);
    ...
    12a4:	50                   	push   %eax
    12a5:	e8 16 25 00 00       	call   37c0 <write>
  close(fd1);
    12aa:	89 34 24             	mov    %esi,(%esp)
    12ad:	e8 16 25 00 00       	call   37c8 <close>
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    12bf:	53                   	push   %ebx
    12c0:	e8 f3 24 00 00       	call   37b8 <read>
  ...
  if(write(fd, buf, 10) != 10){
    ...
    12e8:	53                   	push   %ebx
    12e9:	e8 d2 24 00 00       	call   37c0 <write>
  ...
  close(fd);
    ...
    12fd:	53                   	push   %ebx
    12fe:	e8 c5 24 00 00       	call   37c8 <close>
  unlink("unlinkread");
    1303:	c7 04 24 91 40 00 00 	movl   $0x4091,(%esp)
    130a:	e8 e1 24 00 00       	call   37f0 <unlink>
  printf(1, "unlinkread ok\n");
    130f:	83 c4 08             	add    $0x8,%esp
    1312:	68 39 41 00 00       	push   $0x4139
    1317:	6a 01                	push   $0x1
    1319:	e8 d7 25 00 00       	call   38f5 <printf>
}
    ...
    1330:	6a 01                	push   $0x1
    1332:	e8 be 25 00 00       	call   38f5 <printf>
    exit();
    1337:	e8 64 24 00 00       	call   37a0 <exit>
    printf(1, "open unlinkread failed\n");
    133c:	83 ec 08             	sub    $0x8,%esp
    133f:	68 bc 40 00 00       	push   $0x40bc
    1344:	6a 01                	push   $0x1
    1346:	e8 aa 25 00 00       	call   38f5 <printf>
    exit();
    134b:	e8 50 24 00 00       	call   37a0 <exit>
    printf(1, "unlink unlinkread failed\n");
    1350:	83 ec 08             	sub    $0x8,%esp
    1353:	68 d4 40 00 00       	push   $0x40d4
    1358:	6a 01                	push   $0x1
    135a:	e8 96 25 00 00       	call   38f5 <printf>
    exit();
    135f:	e8 3c 24 00 00       	call   37a0 <exit>
    printf(1, "unlinkread read failed");
    1364:	83 ec 08             	sub    $0x8,%esp
    1367:	68 f2 40 00 00       	push   $0x40f2
    136c:	6a 01                	push   $0x1
    136e:	e8 82 25 00 00       	call   38f5 <printf>
    exit();
    1373:	e8 28 24 00 00       	call   37a0 <exit>
    printf(1, "unlinkread wrong data\n");
    1378:	83 ec 08             	sub    $0x8,%esp
    137b:	68 09 41 00 00       	push   $0x4109
    1380:	6a 01                	push   $0x1
    1382:	e8 6e 25 00 00       	call   38f5 <printf>
    exit();
    1387:	e8 14 24 00 00       	call   37a0 <exit>
    printf(1, "unlinkread write failed\n");
    138c:	83 ec 08             	sub    $0x8,%esp
    138f:	68 20 41 00 00       	push   $0x4120
    1394:	6a 01                	push   $0x1
    1396:	e8 5a 25 00 00       	call   38f5 <printf>
    exit();
    139b:	e8 00 24 00 00       	call   37a0 <exit>
...
linktest(void)
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    13f4:	50                   	push   %eax
    13f5:	e8 c6 23 00 00       	call   37c0 <write>
  ...
  unlink("lf1");
    ...
    1434:	e8 b7 23 00 00       	call   37f0 <unlink>

  if(open("lf1", 0) >= 0){
    1439:	83 c4 08             	add    $0x8,%esp
    143c:	6a 00                	push   $0x0
    143e:	68 52 41 00 00       	push   $0x4152
    1443:	e8 98 23 00 00       	call   37e0 <open>
  ...
  fd = open("lf2", 0);
    ...
    145d:	e8 7e 23 00 00       	call   37e0 <open>
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    147c:	50                   	push   %eax
    147d:	e8 36 23 00 00       	call   37b8 <read>
  ...
  if(link(".", "lf1") >= 0){
    ...
    14eb:	e8 10 23 00 00       	call   3800 <link>
  ...
  printf(1, "linktest ok\n");
    ...
    1503:	6a 01                	push   $0x1
    1505:	e8 eb 23 00 00       	call   38f5 <printf>
}
    ...
    151a:	6a 01                	push   $0x1
    151c:	e8 d4 23 00 00       	call   38f5 <printf>
    exit();
    1521:	e8 7a 22 00 00       	call   37a0 <exit>
    printf(1, "write lf1 failed\n");
    1526:	83 ec 08             	sub    $0x8,%esp
    1529:	68 6d 41 00 00       	push   $0x416d
    152e:	6a 01                	push   $0x1
    1530:	e8 c0 23 00 00       	call   38f5 <printf>
    exit();
    1535:	e8 66 22 00 00       	call   37a0 <exit>
    printf(1, "link lf1 lf2 failed\n");
    153a:	83 ec 08             	sub    $0x8,%esp
    153d:	68 7f 41 00 00       	push   $0x417f
    1542:	6a 01                	push   $0x1
    1544:	e8 ac 23 00 00       	call   38f5 <printf>
    exit();
    1549:	e8 52 22 00 00       	call   37a0 <exit>
    printf(1, "unlinked lf1 but it is still there!\n");
    154e:	83 ec 08             	sub    $0x8,%esp
    1551:	68 60 4d 00 00       	push   $0x4d60
    1556:	6a 01                	push   $0x1
    1558:	e8 98 23 00 00       	call   38f5 <printf>
    exit();
    155d:	e8 3e 22 00 00       	call   37a0 <exit>
    printf(1, "open lf2 failed\n");
    1562:	83 ec 08             	sub    $0x8,%esp
    1565:	68 94 41 00 00       	push   $0x4194
    156a:	6a 01                	push   $0x1
    156c:	e8 84 23 00 00       	call   38f5 <printf>
    exit();
    1571:	e8 2a 22 00 00       	call   37a0 <exit>
    printf(1, "read lf2 failed\n");
    1576:	83 ec 08             	sub    $0x8,%esp
    1579:	68 a5 41 00 00       	push   $0x41a5
    157e:	6a 01                	push   $0x1
    1580:	e8 70 23 00 00       	call   38f5 <printf>
    exit();
    1585:	e8 16 22 00 00       	call   37a0 <exit>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    158a:	83 ec 08             	sub    $0x8,%esp
    158d:	68 b6 41 00 00       	push   $0x41b6
    1592:	6a 01                	push   $0x1
    1594:	e8 5c 23 00 00       	call   38f5 <printf>
    exit();
    1599:	e8 02 22 00 00       	call   37a0 <exit>
    printf(1, "link non-existant succeeded! oops\n");
    159e:	83 ec 08             	sub    $0x8,%esp
    15a1:	68 88 4d 00 00       	push   $0x4d88
    15a6:	6a 01                	push   $0x1
    15a8:	e8 48 23 00 00       	call   38f5 <printf>
    exit();
    15ad:	e8 ee 21 00 00       	call   37a0 <exit>
    printf(1, "link . lf1 succeeded! oops\n");
    15b2:	83 ec 08             	sub    $0x8,%esp
    15b5:	68 d4 41 00 00       	push   $0x41d4
    15ba:	6a 01                	push   $0x1
    15bc:	e8 34 23 00 00       	call   38f5 <printf>
    exit();
    15c1:	e8 da 21 00 00       	call   37a0 <exit>
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    ...
    15d4:	6a 01                	push   $0x1
    15d6:	e8 1a 23 00 00       	call   38f5 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    161e:	50                   	push   %eax
    161f:	e8 bc 21 00 00       	call   37e0 <open>
      if(fd < 0){
    ...
    1632:	50                   	push   %eax
    1633:	e8 90 21 00 00       	call   37c8 <close>
    ...
    163d:	0f 84 9c 00 00 00    	je     16df <concreate+0x119>
      ...
      wait();
    1643:	e8 60 21 00 00       	call   37a8 <wait>
  for(i = 0; i < 40; i++){
    ...
    1660:	50                   	push   %eax
    1661:	e8 8a 21 00 00       	call   37f0 <unlink>
    pid = fork();
    1666:	e8 2d 21 00 00       	call   3798 <fork>
    ...
    16a4:	e8 57 21 00 00       	call   3800 <link>
    ...
    16ba:	e8 41 21 00 00       	call   3800 <link>
    ...
    16d3:	6a 01                	push   $0x1
    16d5:	e8 1b 22 00 00       	call   38f5 <printf>
        exit();
    16da:	e8 c1 20 00 00       	call   37a0 <exit>
      exit();
    16df:	e8 bc 20 00 00       	call   37a0 <exit>
  }
  ...
  fd = open(".", 0);
    ...
    16fe:	e8 dd 20 00 00       	call   37e0 <open>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1715:	50                   	push   %eax
    1716:	53                   	push   %ebx
    1717:	e8 9c 20 00 00       	call   37b8 <read>
    ...
    175f:	6a 01                	push   $0x1
    1761:	e8 8f 21 00 00       	call   38f5 <printf>
        exit();
    1766:	e8 35 20 00 00       	call   37a0 <exit>
        printf(1, "concreate duplicate file %s\n", de.name);
    ...
    1777:	6a 01                	push   $0x1
    1779:	e8 77 21 00 00       	call   38f5 <printf>
        exit();
    177e:	e8 1d 20 00 00       	call   37a0 <exit>
    }
  }
  close(fd);
    1783:	83 ec 0c             	sub    $0xc,%esp
    1786:	53                   	push   %ebx
    1787:	e8 3c 20 00 00       	call   37c8 <close>
  ...
  for(i = 0; i < 40; i++){
    ...
    17a6:	6a 01                	push   $0x1
    17a8:	e8 48 21 00 00       	call   38f5 <printf>
    exit();
    17ad:	e8 ee 1f 00 00       	call   37a0 <exit>
    file[1] = '0' + i;
    pid = fork();
    if(pid < 0){
      printf(1, "fork failed\n");
    ...
    17ba:	6a 01                	push   $0x1
    17bc:	e8 34 21 00 00       	call   38f5 <printf>
      exit();
    17c1:	e8 da 1f 00 00       	call   37a0 <exit>
    }
    if(((i % 3) == 0 && pid == 0) ||
       ((i % 3) == 1 && pid != 0)){
      close(open(file, 0));
    ...
    17ce:	57                   	push   %edi
    17cf:	e8 0c 20 00 00       	call   37e0 <open>
    17d4:	89 04 24             	mov    %eax,(%esp)
    17d7:	e8 ec 1f 00 00       	call   37c8 <close>
      close(open(file, 0));
    17dc:	83 c4 08             	add    $0x8,%esp
    17df:	6a 00                	push   $0x0
    17e1:	57                   	push   %edi
    17e2:	e8 f9 1f 00 00       	call   37e0 <open>
    17e7:	89 04 24             	mov    %eax,(%esp)
    17ea:	e8 d9 1f 00 00       	call   37c8 <close>
      close(open(file, 0));
    17ef:	83 c4 08             	add    $0x8,%esp
    17f2:	6a 00                	push   $0x0
    17f4:	57                   	push   %edi
    17f5:	e8 e6 1f 00 00       	call   37e0 <open>
    17fa:	89 04 24             	mov    %eax,(%esp)
    17fd:	e8 c6 1f 00 00       	call   37c8 <close>
      close(open(file, 0));
    1802:	83 c4 08             	add    $0x8,%esp
    1805:	6a 00                	push   $0x0
    1807:	57                   	push   %edi
    1808:	e8 d3 1f 00 00       	call   37e0 <open>
    180d:	89 04 24             	mov    %eax,(%esp)
    1810:	e8 b3 1f 00 00       	call   37c8 <close>
    ...
    181a:	74 79                	je     1895 <concreate+0x2cf>
      ...
      wait();
    181c:	e8 87 1f 00 00       	call   37a8 <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    182f:	e8 64 1f 00 00       	call   3798 <fork>
    ...
    1872:	57                   	push   %edi
    1873:	e8 78 1f 00 00       	call   37f0 <unlink>
      unlink(file);
    1878:	89 3c 24             	mov    %edi,(%esp)
    187b:	e8 70 1f 00 00       	call   37f0 <unlink>
      unlink(file);
    1880:	89 3c 24             	mov    %edi,(%esp)
    1883:	e8 68 1f 00 00       	call   37f0 <unlink>
      unlink(file);
    1888:	89 3c 24             	mov    %edi,(%esp)
    188b:	e8 60 1f 00 00       	call   37f0 <unlink>
    1890:	83 c4 10             	add    $0x10,%esp
    1893:	eb 83                	jmp    1818 <concreate+0x252>
      exit();
    1895:	e8 06 1f 00 00       	call   37a0 <exit>
  }
  ...
  printf(1, "concreate ok\n");
    ...
    18a2:	6a 01                	push   $0x1
    18a4:	e8 4c 20 00 00       	call   38f5 <printf>
}
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    ...
    18c2:	6a 01                	push   $0x1
    18c4:	e8 2c 20 00 00       	call   38f5 <printf>

  unlink("x");
    18c9:	c7 04 24 fd 44 00 00 	movl   $0x44fd,(%esp)
    18d0:	e8 1b 1f 00 00       	call   37f0 <unlink>
  pid = fork();
    18d5:	e8 be 1e 00 00       	call   3798 <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    18f9:	6a 01                	push   $0x1
    18fb:	e8 f5 1f 00 00       	call   38f5 <printf>
    exit();
    1900:	e8 9b 1e 00 00       	call   37a0 <exit>
  unsigned int x = (pid ? 1 : 97);
  ...
  for(i = 0; i < 100; i++){
    ...
    1919:	e8 c2 1e 00 00       	call   37e0 <open>
    191e:	89 04 24             	mov    %eax,(%esp)
    1921:	e8 a2 1e 00 00       	call   37c8 <close>
  ...
  for(i = 0; i < 100; i++){
    ...
    1962:	e8 89 1e 00 00       	call   37f0 <unlink>
    ...
    1979:	e8 82 1e 00 00       	call   3800 <link>
  ...
  if(pid)
    ...
    wait();
    1987:	e8 1c 1e 00 00       	call   37a8 <wait>
  else
    exit();
  ...
  printf(1, "linkunlink ok\n");
    ...
    1994:	6a 01                	push   $0x1
    1996:	e8 5a 1f 00 00       	call   38f5 <printf>
}
    ...
    19a2:	c3                   	ret    
    exit();
    19a3:	e8 f8 1d 00 00       	call   37a0 <exit>
...
bigdir(void)
{
  ...
  close(fd);
    ...
    19e3:	50                   	push   %eax
    19e4:	e8 df 1d 00 00       	call   37c8 <close>
  ...
  for(i = 0; i < 500; i++){
    ...
    1a34:	e8 c7 1d 00 00       	call   3800 <link>
  ...
  for(i = 0; i < 500; i++){
    ...
    1a4d:	6a 01                	push   $0x1
    1a4f:	e8 a1 1e 00 00       	call   38f5 <printf>
    exit();
    1a54:	e8 47 1d 00 00       	call   37a0 <exit>
      printf(1, "bigdir link failed\n");
    1a59:	83 ec 08             	sub    $0x8,%esp
    1a5c:	68 ba 42 00 00       	push   $0x42ba
    1a61:	6a 01                	push   $0x1
    1a63:	e8 8d 1e 00 00       	call   38f5 <printf>
      exit();
    1a68:	e8 33 1d 00 00       	call   37a0 <exit>
    }
  }
  ...
  unlink("bd");
    ...
    1a75:	e8 76 1d 00 00       	call   37f0 <unlink>
  for(i = 0; i < 500; i++){
    ...
    1ac4:	50                   	push   %eax
    1ac5:	e8 26 1d 00 00       	call   37f0 <unlink>
    ...
    1ad9:	6a 01                	push   $0x1
    1adb:	e8 15 1e 00 00       	call   38f5 <printf>
      exit();
    1ae0:	e8 bb 1c 00 00       	call   37a0 <exit>
    }
  }
  ...
  printf(1, "bigdir ok\n");
    ...
    1aed:	6a 01                	push   $0x1
    1aef:	e8 01 1e 00 00       	call   38f5 <printf>
}
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    ...
    1b08:	6a 01                	push   $0x1
    1b0a:	e8 e6 1d 00 00       	call   38f5 <printf>

  unlink("ff");
    1b0f:	c7 04 24 77 43 00 00 	movl   $0x4377,(%esp)
    1b16:	e8 d5 1c 00 00       	call   37f0 <unlink>
  if(mkdir("dd") != 0){
    1b1b:	c7 04 24 14 44 00 00 	movl   $0x4414,(%esp)
    1b22:	e8 e1 1c 00 00       	call   3808 <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1b3f:	e8 9c 1c 00 00       	call   37e0 <open>
  ...
  write(fd, "ff", 2);
    ...
    1b5b:	50                   	push   %eax
    1b5c:	e8 5f 1c 00 00       	call   37c0 <write>
  close(fd);
    1b61:	89 1c 24             	mov    %ebx,(%esp)
    1b64:	e8 5f 1c 00 00       	call   37c8 <close>

  if(unlink("dd") >= 0){
    1b69:	c7 04 24 14 44 00 00 	movl   $0x4414,(%esp)
    1b70:	e8 7b 1c 00 00       	call   37f0 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1b88:	e8 7b 1c 00 00       	call   3808 <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1ba5:	e8 36 1c 00 00       	call   37e0 <open>
  ...
  write(fd, "FF", 2);
    ...
    1bc1:	50                   	push   %eax
    1bc2:	e8 f9 1b 00 00       	call   37c0 <write>
  close(fd);
    1bc7:	89 1c 24             	mov    %ebx,(%esp)
    1bca:	e8 f9 1b 00 00       	call   37c8 <close>

  fd = open("dd/dd/../ff", 0);
    1bcf:	83 c4 08             	add    $0x8,%esp
    1bd2:	6a 00                	push   $0x0
    1bd4:	68 6e 43 00 00       	push   $0x436e
    1bd9:	e8 02 1c 00 00       	call   37e0 <open>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1bf8:	50                   	push   %eax
    1bf9:	e8 ba 1b 00 00       	call   37b8 <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1c45:	e8 a6 1b 00 00       	call   37f0 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1c5f:	e8 7c 1b 00 00       	call   37e0 <open>
  ...
  if(chdir("dd") != 0){
    ...
    1c77:	e8 94 1b 00 00       	call   3810 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1c8f:	e8 7c 1b 00 00       	call   3810 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ca7:	e8 64 1b 00 00       	call   3810 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1cbf:	e8 4c 1b 00 00       	call   3810 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1cd9:	e8 02 1b 00 00       	call   37e0 <open>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1cf8:	50                   	push   %eax
    1cf9:	e8 ba 1a 00 00       	call   37b8 <read>
  ...
  close(fd);
    ...
    1d0d:	53                   	push   %ebx
    1d0e:	e8 b5 1a 00 00       	call   37c8 <close>

  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1d13:	83 c4 08             	add    $0x8,%esp
    1d16:	6a 00                	push   $0x0
    1d18:	68 4a 43 00 00       	push   $0x434a
    1d1d:	e8 be 1a 00 00       	call   37e0 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1d3a:	e8 a1 1a 00 00       	call   37e0 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1d57:	e8 84 1a 00 00       	call   37e0 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1d74:	e8 67 1a 00 00       	call   37e0 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1d8e:	e8 4d 1a 00 00       	call   37e0 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1da8:	e8 33 1a 00 00       	call   37e0 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1dc5:	e8 36 1a 00 00       	call   3800 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1de2:	e8 19 1a 00 00       	call   3800 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    1dff:	e8 fc 19 00 00       	call   3800 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    1e17:	e8 ec 19 00 00       	call   3808 <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    1e2f:	e8 d4 19 00 00       	call   3808 <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    1e47:	e8 bc 19 00 00       	call   3808 <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    1e5f:	e8 8c 19 00 00       	call   37f0 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    1e77:	e8 74 19 00 00       	call   37f0 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    1e8f:	e8 7c 19 00 00       	call   3810 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    1ea7:	e8 64 19 00 00       	call   3810 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    1ebf:	e8 2c 19 00 00       	call   37f0 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    1ed7:	e8 14 19 00 00       	call   37f0 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    1eef:	e8 fc 18 00 00       	call   37f0 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    1f07:	e8 e4 18 00 00       	call   37f0 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    1f1f:	e8 cc 18 00 00       	call   37f0 <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    1f37:	6a 01                	push   $0x1
    1f39:	e8 b7 19 00 00       	call   38f5 <printf>
}
    ...
    1f4e:	6a 01                	push   $0x1
    1f50:	e8 a0 19 00 00       	call   38f5 <printf>
    exit();
    1f55:	e8 46 18 00 00       	call   37a0 <exit>
    printf(1, "create dd/ff failed\n");
    1f5a:	83 ec 08             	sub    $0x8,%esp
    1f5d:	68 13 43 00 00       	push   $0x4313
    1f62:	6a 01                	push   $0x1
    1f64:	e8 8c 19 00 00       	call   38f5 <printf>
    exit();
    1f69:	e8 32 18 00 00       	call   37a0 <exit>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    1f6e:	83 ec 08             	sub    $0x8,%esp
    1f71:	68 e0 4d 00 00       	push   $0x4de0
    1f76:	6a 01                	push   $0x1
    1f78:	e8 78 19 00 00       	call   38f5 <printf>
    exit();
    1f7d:	e8 1e 18 00 00       	call   37a0 <exit>
    printf(1, "subdir mkdir dd/dd failed\n");
    1f82:	83 ec 08             	sub    $0x8,%esp
    1f85:	68 2f 43 00 00       	push   $0x432f
    1f8a:	6a 01                	push   $0x1
    1f8c:	e8 64 19 00 00       	call   38f5 <printf>
    exit();
    1f91:	e8 0a 18 00 00       	call   37a0 <exit>
    printf(1, "create dd/dd/ff failed\n");
    1f96:	83 ec 08             	sub    $0x8,%esp
    1f99:	68 53 43 00 00       	push   $0x4353
    1f9e:	6a 01                	push   $0x1
    1fa0:	e8 50 19 00 00       	call   38f5 <printf>
    exit();
    1fa5:	e8 f6 17 00 00       	call   37a0 <exit>
    printf(1, "open dd/dd/../ff failed\n");
    1faa:	83 ec 08             	sub    $0x8,%esp
    1fad:	68 7a 43 00 00       	push   $0x437a
    1fb2:	6a 01                	push   $0x1
    1fb4:	e8 3c 19 00 00       	call   38f5 <printf>
    exit();
    1fb9:	e8 e2 17 00 00       	call   37a0 <exit>
    printf(1, "dd/dd/../ff wrong content\n");
    1fbe:	83 ec 08             	sub    $0x8,%esp
    1fc1:	68 93 43 00 00       	push   $0x4393
    1fc6:	6a 01                	push   $0x1
    1fc8:	e8 28 19 00 00       	call   38f5 <printf>
    exit();
    1fcd:	e8 ce 17 00 00       	call   37a0 <exit>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    1fd2:	83 ec 08             	sub    $0x8,%esp
    1fd5:	68 08 4e 00 00       	push   $0x4e08
    1fda:	6a 01                	push   $0x1
    1fdc:	e8 14 19 00 00       	call   38f5 <printf>
    exit();
    1fe1:	e8 ba 17 00 00       	call   37a0 <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    1fe6:	83 ec 08             	sub    $0x8,%esp
    1fe9:	68 b9 43 00 00       	push   $0x43b9
    1fee:	6a 01                	push   $0x1
    1ff0:	e8 00 19 00 00       	call   38f5 <printf>
    exit();
    1ff5:	e8 a6 17 00 00       	call   37a0 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    1ffa:	83 ec 08             	sub    $0x8,%esp
    1ffd:	68 2c 4e 00 00       	push   $0x4e2c
    2002:	6a 01                	push   $0x1
    2004:	e8 ec 18 00 00       	call   38f5 <printf>
    exit();
    2009:	e8 92 17 00 00       	call   37a0 <exit>
    printf(1, "chdir dd failed\n");
    200e:	83 ec 08             	sub    $0x8,%esp
    2011:	68 d1 43 00 00       	push   $0x43d1
    2016:	6a 01                	push   $0x1
    2018:	e8 d8 18 00 00       	call   38f5 <printf>
    exit();
    201d:	e8 7e 17 00 00       	call   37a0 <exit>
    printf(1, "chdir dd/../../dd failed\n");
    2022:	83 ec 08             	sub    $0x8,%esp
    2025:	68 ee 43 00 00       	push   $0x43ee
    202a:	6a 01                	push   $0x1
    202c:	e8 c4 18 00 00       	call   38f5 <printf>
    exit();
    2031:	e8 6a 17 00 00       	call   37a0 <exit>
    printf(1, "chdir dd/../../dd failed\n");
    2036:	83 ec 08             	sub    $0x8,%esp
    2039:	68 ee 43 00 00       	push   $0x43ee
    203e:	6a 01                	push   $0x1
    2040:	e8 b0 18 00 00       	call   38f5 <printf>
    exit();
    2045:	e8 56 17 00 00       	call   37a0 <exit>
    printf(1, "chdir ./.. failed\n");
    204a:	83 ec 08             	sub    $0x8,%esp
    204d:	68 1c 44 00 00       	push   $0x441c
    2052:	6a 01                	push   $0x1
    2054:	e8 9c 18 00 00       	call   38f5 <printf>
    exit();
    2059:	e8 42 17 00 00       	call   37a0 <exit>
    printf(1, "open dd/dd/ffff failed\n");
    205e:	83 ec 08             	sub    $0x8,%esp
    2061:	68 2f 44 00 00       	push   $0x442f
    2066:	6a 01                	push   $0x1
    2068:	e8 88 18 00 00       	call   38f5 <printf>
    exit();
    206d:	e8 2e 17 00 00       	call   37a0 <exit>
    printf(1, "read dd/dd/ffff wrong len\n");
    2072:	83 ec 08             	sub    $0x8,%esp
    2075:	68 47 44 00 00       	push   $0x4447
    207a:	6a 01                	push   $0x1
    207c:	e8 74 18 00 00       	call   38f5 <printf>
    exit();
    2081:	e8 1a 17 00 00       	call   37a0 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    2086:	83 ec 08             	sub    $0x8,%esp
    2089:	68 50 4e 00 00       	push   $0x4e50
    208e:	6a 01                	push   $0x1
    2090:	e8 60 18 00 00       	call   38f5 <printf>
    exit();
    2095:	e8 06 17 00 00       	call   37a0 <exit>
    printf(1, "create dd/ff/ff succeeded!\n");
    209a:	83 ec 08             	sub    $0x8,%esp
    209d:	68 6b 44 00 00       	push   $0x446b
    20a2:	6a 01                	push   $0x1
    20a4:	e8 4c 18 00 00       	call   38f5 <printf>
    exit();
    20a9:	e8 f2 16 00 00       	call   37a0 <exit>
    printf(1, "create dd/xx/ff succeeded!\n");
    20ae:	83 ec 08             	sub    $0x8,%esp
    20b1:	68 90 44 00 00       	push   $0x4490
    20b6:	6a 01                	push   $0x1
    20b8:	e8 38 18 00 00       	call   38f5 <printf>
    exit();
    20bd:	e8 de 16 00 00       	call   37a0 <exit>
    printf(1, "create dd succeeded!\n");
    20c2:	83 ec 08             	sub    $0x8,%esp
    20c5:	68 ac 44 00 00       	push   $0x44ac
    20ca:	6a 01                	push   $0x1
    20cc:	e8 24 18 00 00       	call   38f5 <printf>
    exit();
    20d1:	e8 ca 16 00 00       	call   37a0 <exit>
    printf(1, "open dd rdwr succeeded!\n");
    20d6:	83 ec 08             	sub    $0x8,%esp
    20d9:	68 c2 44 00 00       	push   $0x44c2
    20de:	6a 01                	push   $0x1
    20e0:	e8 10 18 00 00       	call   38f5 <printf>
    exit();
    20e5:	e8 b6 16 00 00       	call   37a0 <exit>
    printf(1, "open dd wronly succeeded!\n");
    20ea:	83 ec 08             	sub    $0x8,%esp
    20ed:	68 db 44 00 00       	push   $0x44db
    20f2:	6a 01                	push   $0x1
    20f4:	e8 fc 17 00 00       	call   38f5 <printf>
    exit();
    20f9:	e8 a2 16 00 00       	call   37a0 <exit>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    20fe:	83 ec 08             	sub    $0x8,%esp
    2101:	68 78 4e 00 00       	push   $0x4e78
    2106:	6a 01                	push   $0x1
    2108:	e8 e8 17 00 00       	call   38f5 <printf>
    exit();
    210d:	e8 8e 16 00 00       	call   37a0 <exit>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    2112:	83 ec 08             	sub    $0x8,%esp
    2115:	68 9c 4e 00 00       	push   $0x4e9c
    211a:	6a 01                	push   $0x1
    211c:	e8 d4 17 00 00       	call   38f5 <printf>
    exit();
    2121:	e8 7a 16 00 00       	call   37a0 <exit>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    2126:	83 ec 08             	sub    $0x8,%esp
    2129:	68 c0 4e 00 00       	push   $0x4ec0
    212e:	6a 01                	push   $0x1
    2130:	e8 c0 17 00 00       	call   38f5 <printf>
    exit();
    2135:	e8 66 16 00 00       	call   37a0 <exit>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    213a:	83 ec 08             	sub    $0x8,%esp
    213d:	68 ff 44 00 00       	push   $0x44ff
    2142:	6a 01                	push   $0x1
    2144:	e8 ac 17 00 00       	call   38f5 <printf>
    exit();
    2149:	e8 52 16 00 00       	call   37a0 <exit>
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    214e:	83 ec 08             	sub    $0x8,%esp
    2151:	68 1a 45 00 00       	push   $0x451a
    2156:	6a 01                	push   $0x1
    2158:	e8 98 17 00 00       	call   38f5 <printf>
    exit();
    215d:	e8 3e 16 00 00       	call   37a0 <exit>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    2162:	83 ec 08             	sub    $0x8,%esp
    2165:	68 35 45 00 00       	push   $0x4535
    216a:	6a 01                	push   $0x1
    216c:	e8 84 17 00 00       	call   38f5 <printf>
    exit();
    2171:	e8 2a 16 00 00       	call   37a0 <exit>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    2176:	83 ec 08             	sub    $0x8,%esp
    2179:	68 52 45 00 00       	push   $0x4552
    217e:	6a 01                	push   $0x1
    2180:	e8 70 17 00 00       	call   38f5 <printf>
    exit();
    2185:	e8 16 16 00 00       	call   37a0 <exit>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    218a:	83 ec 08             	sub    $0x8,%esp
    218d:	68 6e 45 00 00       	push   $0x456e
    2192:	6a 01                	push   $0x1
    2194:	e8 5c 17 00 00       	call   38f5 <printf>
    exit();
    2199:	e8 02 16 00 00       	call   37a0 <exit>
    printf(1, "chdir dd/ff succeeded!\n");
    219e:	83 ec 08             	sub    $0x8,%esp
    21a1:	68 8a 45 00 00       	push   $0x458a
    21a6:	6a 01                	push   $0x1
    21a8:	e8 48 17 00 00       	call   38f5 <printf>
    exit();
    21ad:	e8 ee 15 00 00       	call   37a0 <exit>
    printf(1, "chdir dd/xx succeeded!\n");
    21b2:	83 ec 08             	sub    $0x8,%esp
    21b5:	68 a2 45 00 00       	push   $0x45a2
    21ba:	6a 01                	push   $0x1
    21bc:	e8 34 17 00 00       	call   38f5 <printf>
    exit();
    21c1:	e8 da 15 00 00       	call   37a0 <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    21c6:	83 ec 08             	sub    $0x8,%esp
    21c9:	68 b9 43 00 00       	push   $0x43b9
    21ce:	6a 01                	push   $0x1
    21d0:	e8 20 17 00 00       	call   38f5 <printf>
    exit();
    21d5:	e8 c6 15 00 00       	call   37a0 <exit>
    printf(1, "unlink dd/ff failed\n");
    21da:	83 ec 08             	sub    $0x8,%esp
    21dd:	68 ba 45 00 00       	push   $0x45ba
    21e2:	6a 01                	push   $0x1
    21e4:	e8 0c 17 00 00       	call   38f5 <printf>
    exit();
    21e9:	e8 b2 15 00 00       	call   37a0 <exit>
    printf(1, "unlink non-empty dd succeeded!\n");
    21ee:	83 ec 08             	sub    $0x8,%esp
    21f1:	68 e4 4e 00 00       	push   $0x4ee4
    21f6:	6a 01                	push   $0x1
    21f8:	e8 f8 16 00 00       	call   38f5 <printf>
    exit();
    21fd:	e8 9e 15 00 00       	call   37a0 <exit>
    printf(1, "unlink dd/dd failed\n");
    2202:	83 ec 08             	sub    $0x8,%esp
    2205:	68 cf 45 00 00       	push   $0x45cf
    220a:	6a 01                	push   $0x1
    220c:	e8 e4 16 00 00       	call   38f5 <printf>
    exit();
    2211:	e8 8a 15 00 00       	call   37a0 <exit>
    printf(1, "unlink dd failed\n");
    2216:	83 ec 08             	sub    $0x8,%esp
    2219:	68 e4 45 00 00       	push   $0x45e4
    221e:	6a 01                	push   $0x1
    2220:	e8 d0 16 00 00       	call   38f5 <printf>
    exit();
    2225:	e8 76 15 00 00       	call   37a0 <exit>
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    ...
    2238:	6a 01                	push   $0x1
    223a:	e8 b6 16 00 00       	call   38f5 <printf>

  unlink("bigwrite");
    223f:	c7 04 24 10 46 00 00 	movl   $0x4610,(%esp)
    2246:	e8 a5 15 00 00       	call   37f0 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    225d:	6a 01                	push   $0x1
    225f:	e8 91 16 00 00       	call   38f5 <printf>
      exit();
    2264:	e8 37 15 00 00       	call   37a0 <exit>
    }
    int i;
    for(i = 0; i < 2; i++){
    ...
    2270:	6a 01                	push   $0x1
    2272:	e8 7e 16 00 00       	call   38f5 <printf>
        exit();
    2277:	e8 24 15 00 00       	call   37a0 <exit>
      }
    }
    close(fd);
    227c:	83 ec 0c             	sub    $0xc,%esp
    227f:	57                   	push   %edi
    2280:	e8 43 15 00 00       	call   37c8 <close>
    unlink("bigwrite");
    2285:	c7 04 24 10 46 00 00 	movl   $0x4610,(%esp)
    228c:	e8 5f 15 00 00       	call   37f0 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    22af:	e8 2c 15 00 00       	call   37e0 <open>
    ...
    22d0:	57                   	push   %edi
    22d1:	e8 ea 14 00 00       	call   37c0 <write>
      if(cc != sz){
  ...
  printf(1, "bigwrite ok\n");
    ...
    22ea:	6a 01                	push   $0x1
    22ec:	e8 04 16 00 00       	call   38f5 <printf>
}
...
bigfile(void)
{
  ...
  for(i = 0; i < 20; i++){
    ...
    2362:	56                   	push   %esi
    2363:	e8 58 14 00 00       	call   37c0 <write>
  ...
  for(i = 0; i < 20; i++){
    ...
    237f:	6a 01                	push   $0x1
    2381:	e8 6f 15 00 00       	call   38f5 <printf>
    exit();
    2386:	e8 15 14 00 00       	call   37a0 <exit>
      printf(1, "write bigfile failed\n");
    238b:	83 ec 08             	sub    $0x8,%esp
    238e:	68 74 46 00 00       	push   $0x4674
    2393:	6a 01                	push   $0x1
    2395:	e8 5b 15 00 00       	call   38f5 <printf>
      exit();
    239a:	e8 01 14 00 00       	call   37a0 <exit>
    }
  }
  close(fd);
    239f:	83 ec 0c             	sub    $0xc,%esp
    23a2:	56                   	push   %esi
    23a3:	e8 20 14 00 00       	call   37c8 <close>

  fd = open("bigfile", 0);
    23a8:	83 c4 08             	add    $0x8,%esp
    23ab:	6a 00                	push   $0x0
    23ad:	68 6c 46 00 00       	push   $0x466c
    23b2:	e8 29 14 00 00       	call   37e0 <open>
  ...
  for(i = 0; ; i++){
    ...
    23d7:	57                   	push   %edi
    23d8:	e8 db 13 00 00       	call   37b8 <read>
    if(cc < 0){
  ...
  for(i = 0; ; i++){
    ...
    241b:	6a 01                	push   $0x1
    241d:	e8 d3 14 00 00       	call   38f5 <printf>
    exit();
    2422:	e8 79 13 00 00       	call   37a0 <exit>
      printf(1, "read bigfile failed\n");
    2427:	83 ec 08             	sub    $0x8,%esp
    242a:	68 9f 46 00 00       	push   $0x469f
    242f:	6a 01                	push   $0x1
    2431:	e8 bf 14 00 00       	call   38f5 <printf>
      exit();
    2436:	e8 65 13 00 00       	call   37a0 <exit>
      printf(1, "short read bigfile\n");
    243b:	83 ec 08             	sub    $0x8,%esp
    243e:	68 b4 46 00 00       	push   $0x46b4
    2443:	6a 01                	push   $0x1
    2445:	e8 ab 14 00 00       	call   38f5 <printf>
      exit();
    244a:	e8 51 13 00 00       	call   37a0 <exit>
      printf(1, "read bigfile wrong data\n");
    244f:	83 ec 08             	sub    $0x8,%esp
    2452:	68 c8 46 00 00       	push   $0x46c8
    2457:	6a 01                	push   $0x1
    2459:	e8 97 14 00 00       	call   38f5 <printf>
      exit();
    245e:	e8 3d 13 00 00       	call   37a0 <exit>
  }
  close(fd);
    2463:	83 ec 0c             	sub    $0xc,%esp
    2466:	57                   	push   %edi
    2467:	e8 5c 13 00 00       	call   37c8 <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    247f:	e8 6c 13 00 00       	call   37f0 <unlink>

  printf(1, "bigfile test ok\n");
    2484:	83 c4 08             	add    $0x8,%esp
    2487:	68 fb 46 00 00       	push   $0x46fb
    248c:	6a 01                	push   $0x1
    248e:	e8 62 14 00 00       	call   38f5 <printf>
}
    ...
    24a6:	6a 01                	push   $0x1
    24a8:	e8 48 14 00 00       	call   38f5 <printf>
    exit();
    24ad:	e8 ee 12 00 00       	call   37a0 <exit>
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    ...
    24bd:	6a 01                	push   $0x1
    24bf:	e8 31 14 00 00       	call   38f5 <printf>

  if(mkdir("12345678901234") != 0){
    24c4:	c7 04 24 47 47 00 00 	movl   $0x4747,(%esp)
    24cb:	e8 38 13 00 00       	call   3808 <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    24e3:	e8 20 13 00 00       	call   3808 <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2500:	e8 db 12 00 00       	call   37e0 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2513:	50                   	push   %eax
    2514:	e8 af 12 00 00       	call   37c8 <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2519:	83 c4 08             	add    $0x8,%esp
    251c:	6a 00                	push   $0x0
    251e:	68 c4 4f 00 00       	push   $0x4fc4
    2523:	e8 b8 12 00 00       	call   37e0 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2536:	50                   	push   %eax
    2537:	e8 8c 12 00 00       	call   37c8 <close>

  if(mkdir("12345678901234/12345678901234") == 0){
    253c:	c7 04 24 38 47 00 00 	movl   $0x4738,(%esp)
    2543:	e8 c0 12 00 00       	call   3808 <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2557:	e8 ac 12 00 00       	call   3808 <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    256b:	6a 01                	push   $0x1
    256d:	e8 83 13 00 00       	call   38f5 <printf>
}
    ...
    257f:	6a 01                	push   $0x1
    2581:	e8 6f 13 00 00       	call   38f5 <printf>
    exit();
    2586:	e8 15 12 00 00       	call   37a0 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    258b:	83 ec 08             	sub    $0x8,%esp
    258e:	68 24 4f 00 00       	push   $0x4f24
    2593:	6a 01                	push   $0x1
    2595:	e8 5b 13 00 00       	call   38f5 <printf>
    exit();
    259a:	e8 01 12 00 00       	call   37a0 <exit>
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    259f:	83 ec 08             	sub    $0x8,%esp
    25a2:	68 84 4f 00 00       	push   $0x4f84
    25a7:	6a 01                	push   $0x1
    25a9:	e8 47 13 00 00       	call   38f5 <printf>
    exit();
    25ae:	e8 ed 11 00 00       	call   37a0 <exit>
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
    25b3:	83 ec 08             	sub    $0x8,%esp
    25b6:	68 f4 4f 00 00       	push   $0x4ff4
    25bb:	6a 01                	push   $0x1
    25bd:	e8 33 13 00 00       	call   38f5 <printf>
    exit();
    25c2:	e8 d9 11 00 00       	call   37a0 <exit>
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    25c7:	83 ec 08             	sub    $0x8,%esp
    25ca:	68 30 50 00 00       	push   $0x5030
    25cf:	6a 01                	push   $0x1
    25d1:	e8 1f 13 00 00       	call   38f5 <printf>
    exit();
    25d6:	e8 c5 11 00 00       	call   37a0 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    25db:	83 ec 08             	sub    $0x8,%esp
    25de:	68 80 50 00 00       	push   $0x5080
    25e3:	6a 01                	push   $0x1
    25e5:	e8 0b 13 00 00       	call   38f5 <printf>
    exit();
    25ea:	e8 b1 11 00 00       	call   37a0 <exit>
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    ...
    25fa:	6a 01                	push   $0x1
    25fc:	e8 f4 12 00 00       	call   38f5 <printf>
  if(mkdir("dots") != 0){
    2601:	c7 04 24 6f 47 00 00 	movl   $0x476f,(%esp)
    2608:	e8 fb 11 00 00       	call   3808 <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2620:	e8 eb 11 00 00       	call   3810 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2638:	e8 b3 11 00 00       	call   37f0 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2650:	e8 9b 11 00 00       	call   37f0 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2668:	e8 a3 11 00 00       	call   3810 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2680:	e8 6b 11 00 00       	call   37f0 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2698:	e8 53 11 00 00       	call   37f0 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    26b0:	e8 3b 11 00 00       	call   37f0 <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    26c8:	6a 01                	push   $0x1
    26ca:	e8 26 12 00 00       	call   38f5 <printf>
}
    ...
    26dc:	6a 01                	push   $0x1
    26de:	e8 12 12 00 00       	call   38f5 <printf>
    exit();
    26e3:	e8 b8 10 00 00       	call   37a0 <exit>
    printf(1, "chdir dots failed\n");
    26e8:	83 ec 08             	sub    $0x8,%esp
    26eb:	68 87 47 00 00       	push   $0x4787
    26f0:	6a 01                	push   $0x1
    26f2:	e8 fe 11 00 00       	call   38f5 <printf>
    exit();
    26f7:	e8 a4 10 00 00       	call   37a0 <exit>
    printf(1, "rm . worked!\n");
    26fc:	83 ec 08             	sub    $0x8,%esp
    26ff:	68 9a 47 00 00       	push   $0x479a
    2704:	6a 01                	push   $0x1
    2706:	e8 ea 11 00 00       	call   38f5 <printf>
    exit();
    270b:	e8 90 10 00 00       	call   37a0 <exit>
    printf(1, "rm .. worked!\n");
    2710:	83 ec 08             	sub    $0x8,%esp
    2713:	68 a8 47 00 00       	push   $0x47a8
    2718:	6a 01                	push   $0x1
    271a:	e8 d6 11 00 00       	call   38f5 <printf>
    exit();
    271f:	e8 7c 10 00 00       	call   37a0 <exit>
    printf(1, "chdir / failed\n");
    2724:	83 ec 08             	sub    $0x8,%esp
    2727:	68 ef 3b 00 00       	push   $0x3bef
    272c:	6a 01                	push   $0x1
    272e:	e8 c2 11 00 00       	call   38f5 <printf>
    exit();
    2733:	e8 68 10 00 00       	call   37a0 <exit>
    printf(1, "unlink dots/. worked!\n");
    2738:	83 ec 08             	sub    $0x8,%esp
    273b:	68 be 47 00 00       	push   $0x47be
    2740:	6a 01                	push   $0x1
    2742:	e8 ae 11 00 00       	call   38f5 <printf>
    exit();
    2747:	e8 54 10 00 00       	call   37a0 <exit>
    printf(1, "unlink dots/.. worked!\n");
    274c:	83 ec 08             	sub    $0x8,%esp
    274f:	68 dd 47 00 00       	push   $0x47dd
    2754:	6a 01                	push   $0x1
    2756:	e8 9a 11 00 00       	call   38f5 <printf>
    exit();
    275b:	e8 40 10 00 00       	call   37a0 <exit>
    printf(1, "unlink dots failed!\n");
    2760:	83 ec 08             	sub    $0x8,%esp
    2763:	68 f5 47 00 00       	push   $0x47f5
    2768:	6a 01                	push   $0x1
    276a:	e8 86 11 00 00       	call   38f5 <printf>
    exit();
    276f:	e8 2c 10 00 00       	call   37a0 <exit>
...
dirfile(void)
{
  ...
  close(fd);
    ...
    27a7:	50                   	push   %eax
    27a8:	e8 1b 10 00 00       	call   37c8 <close>
  if(chdir("dirfile") == 0){
    27ad:	c7 04 24 21 48 00 00 	movl   $0x4821,(%esp)
    27b4:	e8 57 10 00 00       	call   3810 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    27ce:	e8 0d 10 00 00       	call   37e0 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    27eb:	e8 f0 0f 00 00       	call   37e0 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2803:	e8 00 10 00 00       	call   3808 <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    281b:	e8 d0 0f 00 00       	call   37f0 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2838:	e8 c3 0f 00 00       	call   3800 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2850:	e8 9b 0f 00 00       	call   37f0 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    286a:	e8 71 0f 00 00       	call   37e0 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2884:	e8 57 0f 00 00       	call   37e0 <open>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2895:	50                   	push   %eax
    2896:	e8 25 0f 00 00       	call   37c0 <write>
  ...
  close(fd);
    ...
    28a9:	53                   	push   %ebx
    28aa:	e8 19 0f 00 00       	call   37c8 <close>

  printf(1, "dir vs file OK\n");
    28af:	83 c4 08             	add    $0x8,%esp
    28b2:	68 f1 48 00 00       	push   $0x48f1
    28b7:	6a 01                	push   $0x1
    28b9:	e8 37 10 00 00       	call   38f5 <printf>
}
    ...
    28ce:	6a 01                	push   $0x1
    28d0:	e8 20 10 00 00       	call   38f5 <printf>
    exit();
    28d5:	e8 c6 0e 00 00       	call   37a0 <exit>
    printf(1, "chdir dirfile succeeded!\n");
    28da:	83 ec 08             	sub    $0x8,%esp
    28dd:	68 40 48 00 00       	push   $0x4840
    28e2:	6a 01                	push   $0x1
    28e4:	e8 0c 10 00 00       	call   38f5 <printf>
    exit();
    28e9:	e8 b2 0e 00 00       	call   37a0 <exit>
    printf(1, "create dirfile/xx succeeded!\n");
    28ee:	83 ec 08             	sub    $0x8,%esp
    28f1:	68 65 48 00 00       	push   $0x4865
    28f6:	6a 01                	push   $0x1
    28f8:	e8 f8 0f 00 00       	call   38f5 <printf>
    exit();
    28fd:	e8 9e 0e 00 00       	call   37a0 <exit>
    printf(1, "create dirfile/xx succeeded!\n");
    2902:	83 ec 08             	sub    $0x8,%esp
    2905:	68 65 48 00 00       	push   $0x4865
    290a:	6a 01                	push   $0x1
    290c:	e8 e4 0f 00 00       	call   38f5 <printf>
    exit();
    2911:	e8 8a 0e 00 00       	call   37a0 <exit>
    printf(1, "mkdir dirfile/xx succeeded!\n");
    2916:	83 ec 08             	sub    $0x8,%esp
    2919:	68 83 48 00 00       	push   $0x4883
    291e:	6a 01                	push   $0x1
    2920:	e8 d0 0f 00 00       	call   38f5 <printf>
    exit();
    2925:	e8 76 0e 00 00       	call   37a0 <exit>
    printf(1, "unlink dirfile/xx succeeded!\n");
    292a:	83 ec 08             	sub    $0x8,%esp
    292d:	68 a0 48 00 00       	push   $0x48a0
    2932:	6a 01                	push   $0x1
    2934:	e8 bc 0f 00 00       	call   38f5 <printf>
    exit();
    2939:	e8 62 0e 00 00       	call   37a0 <exit>
    printf(1, "link to dirfile/xx succeeded!\n");
    293e:	83 ec 08             	sub    $0x8,%esp
    2941:	68 b4 50 00 00       	push   $0x50b4
    2946:	6a 01                	push   $0x1
    2948:	e8 a8 0f 00 00       	call   38f5 <printf>
    exit();
    294d:	e8 4e 0e 00 00       	call   37a0 <exit>
    printf(1, "unlink dirfile failed!\n");
    2952:	83 ec 08             	sub    $0x8,%esp
    2955:	68 c5 48 00 00       	push   $0x48c5
    295a:	6a 01                	push   $0x1
    295c:	e8 94 0f 00 00       	call   38f5 <printf>
    exit();
    2961:	e8 3a 0e 00 00       	call   37a0 <exit>
    printf(1, "open . for writing succeeded!\n");
    2966:	83 ec 08             	sub    $0x8,%esp
    2969:	68 d4 50 00 00       	push   $0x50d4
    296e:	6a 01                	push   $0x1
    2970:	e8 80 0f 00 00       	call   38f5 <printf>
    exit();
    2975:	e8 26 0e 00 00       	call   37a0 <exit>
    printf(1, "write . succeeded!\n");
    297a:	83 ec 08             	sub    $0x8,%esp
    297d:	68 dd 48 00 00       	push   $0x48dd
    2982:	6a 01                	push   $0x1
    2984:	e8 6c 0f 00 00       	call   38f5 <printf>
    exit();
    2989:	e8 12 0e 00 00       	call   37a0 <exit>
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    ...
    299a:	6a 01                	push   $0x1
    299c:	e8 54 0f 00 00       	call   38f5 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    29b3:	6a 01                	push   $0x1
    29b5:	e8 3b 0f 00 00       	call   38f5 <printf>
      exit();
    29ba:	e8 e1 0d 00 00       	call   37a0 <exit>
    }
    if(chdir("irefd") != 0){
    ...
    29c7:	6a 01                	push   $0x1
    29c9:	e8 27 0f 00 00       	call   38f5 <printf>
      exit();
    29ce:	e8 cd 0d 00 00       	call   37a0 <exit>
    ...
    29d6:	50                   	push   %eax
    29d7:	e8 ec 0d 00 00       	call   37c8 <close>
    ...
    29ec:	e8 ff 0d 00 00       	call   37f0 <unlink>
  for(i = 0; i < 50 + 1; i++){
    ...
    2a08:	e8 fb 0d 00 00       	call   3808 <mkdir>
    ...
    2a1c:	e8 ef 0d 00 00       	call   3810 <chdir>
    ...
    2a71:	e8 6a 0d 00 00       	call   37e0 <open>
    if(fd >= 0)
    ...
    2a84:	50                   	push   %eax
    2a85:	e8 3e 0d 00 00       	call   37c8 <close>
  ...
  chdir("/");
    ...
    2a9a:	e8 71 0d 00 00       	call   3810 <chdir>
  printf(1, "empty file name OK\n");
    2a9f:	83 c4 08             	add    $0x8,%esp
    2aa2:	68 40 49 00 00       	push   $0x4940
    2aa7:	6a 01                	push   $0x1
    2aa9:	e8 47 0e 00 00       	call   38f5 <printf>
}
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    ...
    2ac2:	6a 01                	push   $0x1
    2ac4:	e8 2c 0e 00 00       	call   38f5 <printf>
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2ad9:	e8 ba 0c 00 00       	call   3798 <fork>
    if(pid < 0)
  ...
  for(n=0; n<1000; n++){
    ...
    2ae7:	eb e8                	jmp    2ad1 <forktest+0x1b>
      exit();
    2ae9:	e8 b2 0c 00 00       	call   37a0 <exit>
  }
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2afa:	e8 a9 0c 00 00       	call   37a8 <wait>
  ...
  for(; n > 0; n--){
    ...
    2b10:	6a 01                	push   $0x1
    2b12:	e8 de 0d 00 00       	call   38f5 <printf>
    exit();
    2b17:	e8 84 0c 00 00       	call   37a0 <exit>
      printf(1, "wait stopped early\n");
    2b1c:	83 ec 08             	sub    $0x8,%esp
    2b1f:	68 5f 49 00 00       	push   $0x495f
    2b24:	6a 01                	push   $0x1
    2b26:	e8 ca 0d 00 00       	call   38f5 <printf>
      exit();
    2b2b:	e8 70 0c 00 00       	call   37a0 <exit>
    }
  }

  if(wait() != -1){
    2b30:	e8 73 0c 00 00       	call   37a8 <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2b42:	6a 01                	push   $0x1
    2b44:	e8 ac 0d 00 00       	call   38f5 <printf>
}
    ...
    2b59:	6a 01                	push   $0x1
    2b5b:	e8 95 0d 00 00       	call   38f5 <printf>
    exit();
    2b60:	e8 3b 0c 00 00       	call   37a0 <exit>
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2b79:	e8 77 0d 00 00       	call   38f5 <printf>
  oldbrk = sbrk(0);
    2b7e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    2b85:	e8 9e 0c 00 00       	call   3828 <sbrk>
    2b8a:	89 c7                	mov    %eax,%edi

  // can one sbrk() less than a page?
  a = sbrk(0);
    2b8c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    2b93:	e8 90 0c 00 00       	call   3828 <sbrk>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2bad:	6a 01                	push   $0x1
    2baf:	e8 74 0c 00 00       	call   3828 <sbrk>
    if(b != a){
  ...
  for(i = 0; i < 5000; i++){
    ...
    2bd7:	e8 19 0d 00 00       	call   38f5 <printf>
      exit();
    2bdc:	83 c4 20             	add    $0x20,%esp
    2bdf:	e8 bc 0b 00 00       	call   37a0 <exit>
  }
  pid = fork();
    2be4:	e8 af 0b 00 00       	call   3798 <fork>
  ...
  c = sbrk(1);
    ...
    2bf6:	6a 01                	push   $0x1
    2bf8:	e8 2b 0c 00 00       	call   3828 <sbrk>
  c = sbrk(1);
    2bfd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c04:	e8 1f 0c 00 00       	call   3828 <sbrk>
  if(c != a + 1){
  ...
  if(pid == 0)
    ...
    exit();
  wait();
    2c1f:	e8 84 0b 00 00       	call   37a8 <wait>
...
#define BIG (100*1024*1024)
  a = sbrk(0);
    ...
    2c27:	6a 00                	push   $0x0
    2c29:	e8 fa 0b 00 00       	call   3828 <sbrk>
  ...
  p = sbrk(amt);
    ...
    2c3a:	e8 e9 0b 00 00       	call   3828 <sbrk>
  if (p != a) {
  ...
  a = sbrk(0);
    ...
    2c4d:	6a 00                	push   $0x0
    2c4f:	e8 d4 0b 00 00       	call   3828 <sbrk>
    2c54:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2c56:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
    2c5d:	e8 c6 0b 00 00       	call   3828 <sbrk>
  ...
  c = sbrk(0);
    ...
    2c71:	6a 00                	push   $0x0
    2c73:	e8 b0 0b 00 00       	call   3828 <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2c8c:	6a 00                	push   $0x0
    2c8e:	e8 95 0b 00 00       	call   3828 <sbrk>
    2c93:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2c95:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    2c9c:	e8 87 0b 00 00       	call   3828 <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2cb1:	6a 00                	push   $0x0
    2cb3:	e8 70 0b 00 00       	call   3828 <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    2d18:	e8 03 0b 00 00       	call   3820 <getpid>
    2d1d:	89 c6                	mov    %eax,%esi
    pid = fork();
    2d1f:	e8 74 0a 00 00       	call   3798 <fork>
    if(pid < 0){
    ...
    wait();
    2d32:	e8 71 0a 00 00       	call   37a8 <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2d4d:	e8 a3 0b 00 00       	call   38f5 <printf>
    exit();
    2d52:	e8 49 0a 00 00       	call   37a0 <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    2d57:	83 ec 08             	sub    $0x8,%esp
    2d5a:	68 d1 49 00 00       	push   $0x49d1
    2d5f:	ff 35 d4 5c 00 00    	push   0x5cd4
    2d65:	e8 8b 0b 00 00       	call   38f5 <printf>
    exit();
    2d6a:	e8 31 0a 00 00       	call   37a0 <exit>
    exit();
    2d6f:	e8 2c 0a 00 00       	call   37a0 <exit>
    printf(stdout, "sbrk test failed to grow big address space; enough phys mem?\n");
    2d74:	83 ec 08             	sub    $0x8,%esp
    2d77:	68 18 51 00 00       	push   $0x5118
    2d7c:	ff 35 d4 5c 00 00    	push   0x5cd4
    2d82:	e8 6e 0b 00 00       	call   38f5 <printf>
    exit();
    2d87:	e8 14 0a 00 00       	call   37a0 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    2d8c:	83 ec 08             	sub    $0x8,%esp
    2d8f:	68 ed 49 00 00       	push   $0x49ed
    2d94:	ff 35 d4 5c 00 00    	push   0x5cd4
    2d9a:	e8 56 0b 00 00       	call   38f5 <printf>
    exit();
    2d9f:	e8 fc 09 00 00       	call   37a0 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    2da4:	50                   	push   %eax
    2da5:	53                   	push   %ebx
    2da6:	68 58 51 00 00       	push   $0x5158
    2dab:	ff 35 d4 5c 00 00    	push   0x5cd4
    2db1:	e8 3f 0b 00 00       	call   38f5 <printf>
    exit();
    2db6:	e8 e5 09 00 00       	call   37a0 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    2dbb:	56                   	push   %esi
    2dbc:	53                   	push   %ebx
    2dbd:	68 90 51 00 00       	push   $0x5190
    2dc2:	ff 35 d4 5c 00 00    	push   0x5cd4
    2dc8:	e8 28 0b 00 00       	call   38f5 <printf>
    exit();
    2dcd:	e8 ce 09 00 00       	call   37a0 <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    2dd2:	83 ec 08             	sub    $0x8,%esp
    2dd5:	68 b8 51 00 00       	push   $0x51b8
    2dda:	ff 35 d4 5c 00 00    	push   0x5cd4
    2de0:	e8 10 0b 00 00       	call   38f5 <printf>
    exit();
    2de5:	e8 b6 09 00 00       	call   37a0 <exit>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    2dea:	50                   	push   %eax
    2deb:	53                   	push   %ebx
    2dec:	68 e8 51 00 00       	push   $0x51e8
    2df1:	ff 35 d4 5c 00 00    	push   0x5cd4
    2df7:	e8 f9 0a 00 00       	call   38f5 <printf>
    exit();
    2dfc:	e8 9f 09 00 00       	call   37a0 <exit>
      printf(stdout, "fork failed\n");
    2e01:	83 ec 08             	sub    $0x8,%esp
    2e04:	68 e5 4a 00 00       	push   $0x4ae5
    2e09:	ff 35 d4 5c 00 00    	push   0x5cd4
    2e0f:	e8 e1 0a 00 00       	call   38f5 <printf>
      exit();
    2e14:	e8 87 09 00 00       	call   37a0 <exit>
      printf(stdout, "oops could read %x = %x\n", a, *a);
    ...
    2e29:	e8 c7 0a 00 00       	call   38f5 <printf>
      kill(ppid);
    2e2e:	89 34 24             	mov    %esi,(%esp)
    2e31:	e8 9a 09 00 00       	call   37d0 <kill>
      exit();
    2e36:	e8 65 09 00 00       	call   37a0 <exit>
  }
  ...
  if(pipe(fds) != 0){
    ...
    2e41:	50                   	push   %eax
    2e42:	e8 69 09 00 00       	call   37b0 <pipe>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    if((pids[i] = fork()) == 0){
    2eb2:	e8 e1 08 00 00       	call   3798 <fork>
    ...
    2ed0:	e8 e3 08 00 00       	call   37b8 <read>
  ...
  c = sbrk(4096);
    ...
    2ee2:	e8 41 09 00 00       	call   3828 <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f02:	50                   	push   %eax
    2f03:	e8 c8 08 00 00       	call   37d0 <kill>
    wait();
    2f08:	e8 9b 08 00 00       	call   37a8 <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2f1a:	6a 00                	push   $0x0
    2f1c:	e8 07 09 00 00       	call   3828 <sbrk>
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2f36:	e8 ba 09 00 00       	call   38f5 <printf>
}
    ...
    2f54:	e8 9c 09 00 00       	call   38f5 <printf>
    exit();
    2f59:	e8 42 08 00 00       	call   37a0 <exit>
    sbrk(-(sbrk(0) - oldbrk));
    2f5e:	83 ec 0c             	sub    $0xc,%esp
    2f61:	6a 00                	push   $0x0
    2f63:	e8 c0 08 00 00       	call   3828 <sbrk>
    2f68:	29 c7                	sub    %eax,%edi
    2f6a:	89 3c 24             	mov    %edi,(%esp)
    2f6d:	e8 b6 08 00 00       	call   3828 <sbrk>
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    ...
    2f8b:	e8 65 09 00 00       	call   38f5 <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    if((pid = fork()) == 0){
    2fa0:	e8 f3 07 00 00       	call   3798 <fork>
    ...
    2fae:	6a 00                	push   $0x0
    2fb0:	e8 7b 08 00 00       	call   3830 <sleep>
    sleep(0);
    2fb5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    2fbc:	e8 6f 08 00 00       	call   3830 <sleep>
    kill(pid);
    2fc1:	89 1c 24             	mov    %ebx,(%esp)
    2fc4:	e8 07 08 00 00       	call   37d0 <kill>
    wait();
    2fc9:	e8 da 07 00 00       	call   37a8 <wait>
    ...
    2fd7:	e8 24 08 00 00       	call   3800 <link>
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    2fea:	eb ac                	jmp    2f98 <validatetest+0x20>
      exit();
    2fec:	e8 af 07 00 00       	call   37a0 <exit>
      printf(stdout, "link should not succeed\n");
    2ff1:	83 ec 08             	sub    $0x8,%esp
    2ff4:	68 64 4a 00 00       	push   $0x4a64
    2ff9:	ff 35 d4 5c 00 00    	push   0x5cd4
    2fff:	e8 f1 08 00 00       	call   38f5 <printf>
      exit();
    3004:	e8 97 07 00 00       	call   37a0 <exit>
    }
  }
  ...
  printf(stdout, "validate ok\n");
    ...
    3017:	e8 d9 08 00 00       	call   38f5 <printf>
}
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    ...
    3037:	e8 b9 08 00 00       	call   38f5 <printf>
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    3067:	e8 89 08 00 00       	call   38f5 <printf>
      exit();
    306c:	e8 2f 07 00 00       	call   37a0 <exit>
    }
  }
  printf(stdout, "bss test ok\n");
    ...
    307f:	e8 71 08 00 00       	call   38f5 <printf>
}
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    ...
    3094:	e8 57 07 00 00       	call   37f0 <unlink>
  pid = fork();
    3099:	e8 fa 06 00 00       	call   3798 <fork>
  if(pid == 0){
  ...
  wait();
    30ab:	e8 f8 06 00 00       	call   37a8 <wait>
  fd = open("bigarg-ok", 0);
    30b0:	83 ec 08             	sub    $0x8,%esp
    30b3:	6a 00                	push   $0x0
    30b5:	68 b2 4a 00 00       	push   $0x4ab2
    30ba:	e8 21 07 00 00       	call   37e0 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    30cd:	50                   	push   %eax
    30ce:	e8 f5 06 00 00       	call   37c8 <close>
  unlink("bigarg-ok");
    30d3:	c7 04 24 b2 4a 00 00 	movl   $0x4ab2,(%esp)
    30da:	e8 11 07 00 00       	call   37f0 <unlink>
}
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    ...
    3196:	6a 01                	push   $0x1
    3198:	e8 58 07 00 00       	call   38f5 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3234:	6a 01                	push   $0x1
    3236:	e8 ba 06 00 00       	call   38f5 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    323b:	83 c4 08             	add    $0x8,%esp
    323e:	68 02 02 00 00       	push   $0x202
    3243:	56                   	push   %esi
    3244:	e8 97 05 00 00       	call   37e0 <open>
    ...
    325e:	6a 01                	push   $0x1
    3260:	e8 90 06 00 00       	call   38f5 <printf>
      break;
    ...
    327f:	56                   	push   %esi
    3280:	e8 3b 05 00 00       	call   37c0 <write>
      if(cc < 512)
    ...
    329c:	6a 01                	push   $0x1
    329e:	e8 52 06 00 00       	call   38f5 <printf>
    close(fd);
    32a3:	89 34 24             	mov    %esi,(%esp)
    32a6:	e8 1d 05 00 00       	call   37c8 <close>
    if(total == 0)
  ...
  while(nfiles >= 0){
    ...
    3347:	50                   	push   %eax
    3348:	e8 a3 04 00 00       	call   37f0 <unlink>
    nfiles--;
  ...
  printf(1, "fsfull test finished\n");
    ...
    3363:	6a 01                	push   $0x1
    3365:	e8 8b 05 00 00       	call   38f5 <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    ...
    3380:	6a 01                	push   $0x1
    3382:	e8 6e 05 00 00       	call   38f5 <printf>
  pid = fork();
    3387:	e8 0c 04 00 00       	call   3798 <fork>
  if(pid == 0){
  ...
  wait();
    3395:	e8 0e 04 00 00       	call   37a8 <wait>
  printf(1, "uio test done\n");
    339a:	83 ec 08             	sub    $0x8,%esp
    339d:	68 60 4b 00 00       	push   $0x4b60
    33a2:	6a 01                	push   $0x1
    33a4:	e8 4c 05 00 00       	call   38f5 <printf>
}
    ...
    33c7:	6a 01                	push   $0x1
    33c9:	e8 27 05 00 00       	call   38f5 <printf>
    exit();
    33ce:	e8 cd 03 00 00       	call   37a0 <exit>
    printf (1, "fork failed\n");
    33d3:	83 ec 08             	sub    $0x8,%esp
    33d6:	68 e5 4a 00 00       	push   $0x4ae5
    33db:	6a 01                	push   $0x1
    33dd:	e8 13 05 00 00       	call   38f5 <printf>
    exit();
    33e2:	e8 b9 03 00 00       	call   37a0 <exit>
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    ...
    33f5:	e8 e6 03 00 00       	call   37e0 <open>
  if (fd < 0) {
  ...
  printf(1, "arg test passed\n");
    ...
    3443:	6a 02                	push   $0x2
    3445:	e8 ab 04 00 00       	call   38f5 <printf>
    exit();
    344a:	e8 51 03 00 00       	call   37a0 <exit>
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    ...
    347a:	6a 01                	push   $0x1
    347c:	e8 74 04 00 00       	call   38f5 <printf>

  if(open("usertests.ran", 0) >= 0){
    3481:	83 c4 08             	add    $0x8,%esp
    3484:	6a 00                	push   $0x0
    3486:	68 a6 4b 00 00       	push   $0x4ba6
    348b:	e8 50 03 00 00       	call   37e0 <open>
    ...
    349f:	6a 01                	push   $0x1
    34a1:	e8 4f 04 00 00       	call   38f5 <printf>
    exit();
    34a6:	e8 f5 02 00 00       	call   37a0 <exit>
  }
  close(open("usertests.ran", O_CREATE));
    34ab:	83 ec 08             	sub    $0x8,%esp
    34ae:	68 00 02 00 00       	push   $0x200
    34b3:	68 a6 4b 00 00       	push   $0x4ba6
    34b8:	e8 23 03 00 00       	call   37e0 <open>
    34bd:	89 04 24             	mov    %eax,(%esp)
    34c0:	e8 03 03 00 00       	call   37c8 <close>
  ...
  exit();
    3574:	e8 27 02 00 00       	call   37a0 <exit>
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    363c:	50                   	push   %eax
    363d:	6a 00                	push   $0x0
    363f:	e8 74 01 00 00       	call   37b8 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    367d:	e8 5e 01 00 00       	call   37e0 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3691:	50                   	push   %eax
    3692:	e8 61 01 00 00       	call   37f8 <fstat>
    3697:	89 c6                	mov    %eax,%esi
  close(fd);
    3699:	89 1c 24             	mov    %ebx,(%esp)
    369c:	e8 27 01 00 00       	call   37c8 <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
  ...
  void* stack = malloc(PGSIZE);
    3716:	68 00 10 00 00       	push   $0x1000
    371b:	e8 fb 03 00 00       	call   3b1b <malloc>

  return clone(start_routine, arg1, arg2, stack);
    3720:	50                   	push   %eax
    3721:	ff 75 10             	push   0x10(%ebp)
    3724:	ff 75 0c             	push   0xc(%ebp)
    3727:	ff 75 08             	push   0x8(%ebp)
    372a:	e8 11 01 00 00       	call   3840 <clone>
}
    372f:	c9                   	leave  
    3730:	c3                   	ret    

00003731 <thread_join>:

int thread_join(){
    3731:	55                   	push   %ebp
    3732:	89 e5                	mov    %esp,%ebp
    3734:	53                   	push   %ebx
    3735:	83 ec 20             	sub    $0x20,%esp
  void *stack; //Get stack as void*
  int x = join(&stack); //Get join results with **stack
    3738:	8d 45 f4             	lea    -0xc(%ebp),%eax
    373b:	50                   	push   %eax
    373c:	e8 07 01 00 00       	call   3848 <join>
  if (x < 0) {
    3741:	83 c4 10             	add    $0x10,%esp
    3744:	85 c0                	test   %eax,%eax
    3746:	78 17                	js     375f <thread_join+0x2e>
    3748:	89 c3                	mov    %eax,%ebx
    return -1;
  }
  //Free stack
  free(stack);
    374a:	83 ec 0c             	sub    $0xc,%esp
    374d:	ff 75 f4             	push   -0xc(%ebp)
    3750:	e8 06 03 00 00       	call   3a5b <free>
  return x;
    3755:	83 c4 10             	add    $0x10,%esp
}
    3758:	89 d8                	mov    %ebx,%eax
    375a:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    375d:	c9                   	leave  
    375e:	c3                   	ret    
    return -1;
    375f:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
    3764:	eb f2                	jmp    3758 <thread_join+0x27>

00003766 <lock_init>:

void lock_init(lock_t *spin){
    3766:	55                   	push   %ebp
    3767:	89 e5                	mov    %esp,%ebp
  spin->locked = 0;
    3769:	8b 45 08             	mov    0x8(%ebp),%eax
    376c:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
    3772:	5d                   	pop    %ebp
    3773:	c3                   	ret    

00003774 <lock_acquire>:

void lock_acquire(lock_t *spin){
    3774:	55                   	push   %ebp
    3775:	89 e5                	mov    %esp,%ebp
    3777:	8b 55 08             	mov    0x8(%ebp),%edx
xchg(volatile uint *addr, uint newval)
{
  ...
  asm volatile("lock; xchgl %0, %1" :
    377a:	b8 01 00 00 00       	mov    $0x1,%eax
    377f:	f0 87 02             	lock xchg %eax,(%edx)
  while(xchg(&spin->locked, 1) != 0);
    3782:	85 c0                	test   %eax,%eax
    3784:	75 f4                	jne    377a <lock_acquire+0x6>

}
    3786:	5d                   	pop    %ebp
    3787:	c3                   	ret    

00003788 <lock_release>:

void lock_release(lock_t *spin){
    3788:	55                   	push   %ebp
    3789:	89 e5                	mov    %esp,%ebp
    378b:	8b 55 08             	mov    0x8(%ebp),%edx
    378e:	b8 00 00 00 00       	mov    $0x0,%eax
    3793:	f0 87 02             	lock xchg %eax,(%edx)
  xchg(&spin->locked, 0);
...
SYSCALL(fork)
    3798:	b8 01 00 00 00       	mov    $0x1,%eax
    379d:	cd 40                	int    $0x40
    379f:	c3                   	ret    

000037a0 <exit>:
SYSCALL(exit)
    37a0:	b8 02 00 00 00       	mov    $0x2,%eax
    37a5:	cd 40                	int    $0x40
    37a7:	c3                   	ret    

000037a8 <wait>:
SYSCALL(wait)
    37a8:	b8 03 00 00 00       	mov    $0x3,%eax
    37ad:	cd 40                	int    $0x40
    37af:	c3                   	ret    

000037b0 <pipe>:
SYSCALL(pipe)
    37b0:	b8 04 00 00 00       	mov    $0x4,%eax
    37b5:	cd 40                	int    $0x40
    37b7:	c3                   	ret    

000037b8 <read>:
SYSCALL(read)
    37b8:	b8 05 00 00 00       	mov    $0x5,%eax
    37bd:	cd 40                	int    $0x40
    37bf:	c3                   	ret    

000037c0 <write>:
SYSCALL(write)
    37c0:	b8 10 00 00 00       	mov    $0x10,%eax
    37c5:	cd 40                	int    $0x40
    37c7:	c3                   	ret    

000037c8 <close>:
SYSCALL(close)
    37c8:	b8 15 00 00 00       	mov    $0x15,%eax
    37cd:	cd 40                	int    $0x40
    37cf:	c3                   	ret    

000037d0 <kill>:
SYSCALL(kill)
    37d0:	b8 06 00 00 00       	mov    $0x6,%eax
    37d5:	cd 40                	int    $0x40
    37d7:	c3                   	ret    

000037d8 <exec>:
SYSCALL(exec)
    37d8:	b8 07 00 00 00       	mov    $0x7,%eax
    37dd:	cd 40                	int    $0x40
    37df:	c3                   	ret    

000037e0 <open>:
SYSCALL(open)
    37e0:	b8 0f 00 00 00       	mov    $0xf,%eax
    37e5:	cd 40                	int    $0x40
    37e7:	c3                   	ret    

000037e8 <mknod>:
SYSCALL(mknod)
    37e8:	b8 11 00 00 00       	mov    $0x11,%eax
    37ed:	cd 40                	int    $0x40
    37ef:	c3                   	ret    

000037f0 <unlink>:
SYSCALL(unlink)
    37f0:	b8 12 00 00 00       	mov    $0x12,%eax
    37f5:	cd 40                	int    $0x40
    37f7:	c3                   	ret    

000037f8 <fstat>:
SYSCALL(fstat)
    37f8:	b8 08 00 00 00       	mov    $0x8,%eax
    37fd:	cd 40                	int    $0x40
    37ff:	c3                   	ret    

00003800 <link>:
SYSCALL(link)
    3800:	b8 13 00 00 00       	mov    $0x13,%eax
    3805:	cd 40                	int    $0x40
    3807:	c3                   	ret    

00003808 <mkdir>:
SYSCALL(mkdir)
    3808:	b8 14 00 00 00       	mov    $0x14,%eax
    380d:	cd 40                	int    $0x40
    380f:	c3                   	ret    

00003810 <chdir>:
SYSCALL(chdir)
    3810:	b8 09 00 00 00       	mov    $0x9,%eax
    3815:	cd 40                	int    $0x40
    3817:	c3                   	ret    

00003818 <dup>:
SYSCALL(dup)
    3818:	b8 0a 00 00 00       	mov    $0xa,%eax
    381d:	cd 40                	int    $0x40
    381f:	c3                   	ret    

00003820 <getpid>:
SYSCALL(getpid)
    3820:	b8 0b 00 00 00       	mov    $0xb,%eax
    3825:	cd 40                	int    $0x40
    3827:	c3                   	ret    

00003828 <sbrk>:
SYSCALL(sbrk)
    3828:	b8 0c 00 00 00       	mov    $0xc,%eax
    382d:	cd 40                	int    $0x40
    382f:	c3                   	ret    

00003830 <sleep>:
SYSCALL(sleep)
    3830:	b8 0d 00 00 00       	mov    $0xd,%eax
    3835:	cd 40                	int    $0x40
    3837:	c3                   	ret    

00003838 <uptime>:
SYSCALL(uptime)
    3838:	b8 0e 00 00 00       	mov    $0xe,%eax
    383d:	cd 40                	int    $0x40
    383f:	c3                   	ret    

00003840 <clone>:
SYSCALL(clone)
    3840:	b8 16 00 00 00       	mov    $0x16,%eax
    3845:	cd 40                	int    $0x40
    3847:	c3                   	ret    

00003848 <join>:
    3848:	b8 17 00 00 00       	mov    $0x17,%eax
    384d:	cd 40                	int    $0x40
    384f:	c3                   	ret    
...
putc(int fd, char c)
{
    ...
    3853:	83 ec 1c             	sub    $0x1c,%esp
    3856:	88 55 f4             	mov    %dl,-0xc(%ebp)
  write(fd, &c, 1);
    3859:	6a 01                	push   $0x1
    385b:	8d 55 f4             	lea    -0xc(%ebp),%edx
    385e:	52                   	push   %edx
    385f:	50                   	push   %eax
    3860:	e8 5b ff ff ff       	call   37c0 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    386e:	56                   	push   %esi
    386f:	53                   	push   %ebx
    3870:	83 ec 2c             	sub    $0x2c,%esp
    3873:	89 45 d0             	mov    %eax,-0x30(%ebp)
    3876:	89 d0                	mov    %edx,%eax
    3878:	89 ce                	mov    %ecx,%esi
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    387a:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    387e:	0f 95 c1             	setne  %cl
    3881:	c1 ea 1f             	shr    $0x1f,%edx
    3884:	84 d1                	test   %dl,%cl
    3886:	74 44                	je     38cc <printint+0x62>
    neg = 1;
    x = -xx;
    3888:	f7 d8                	neg    %eax
    388a:	89 c1                	mov    %eax,%ecx
    neg = 1;
    388c:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
  } else {
    x = xx;
  }

  i = 0;
    3893:	bb 00 00 00 00       	mov    $0x0,%ebx
  do{
    buf[i++] = digits[x % base];
    3898:	89 c8                	mov    %ecx,%eax
    389a:	ba 00 00 00 00       	mov    $0x0,%edx
    389f:	f7 f6                	div    %esi
    38a1:	89 df                	mov    %ebx,%edi
    38a3:	83 c3 01             	add    $0x1,%ebx
    38a6:	0f b6 92 9c 53 00 00 	movzbl 0x539c(%edx),%edx
    38ad:	88 54 3d d8          	mov    %dl,-0x28(%ebp,%edi,1)
  }while((x /= base) != 0);
    38b1:	89 ca                	mov    %ecx,%edx
    38b3:	89 c1                	mov    %eax,%ecx
    38b5:	39 d6                	cmp    %edx,%esi
    38b7:	76 df                	jbe    3898 <printint+0x2e>
  if(neg)
    38b9:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
    38bd:	74 31                	je     38f0 <printint+0x86>
    buf[i++] = '-';
    38bf:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
    38c4:	8d 5f 02             	lea    0x2(%edi),%ebx
    38c7:	8b 75 d0             	mov    -0x30(%ebp),%esi
    38ca:	eb 17                	jmp    38e3 <printint+0x79>
    x = xx;
    38cc:	89 c1                	mov    %eax,%ecx
  neg = 0;
    38ce:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
    38d5:	eb bc                	jmp    3893 <printint+0x29>

  while(--i >= 0)
    putc(fd, buf[i]);
    38d7:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
    38dc:	89 f0                	mov    %esi,%eax
    38de:	e8 6d ff ff ff       	call   3850 <putc>
  while(--i >= 0)
    38e3:	83 eb 01             	sub    $0x1,%ebx
    38e6:	79 ef                	jns    38d7 <printint+0x6d>
}
    38e8:	83 c4 2c             	add    $0x2c,%esp
    38eb:	5b                   	pop    %ebx
    38ec:	5e                   	pop    %esi
    38ed:	5f                   	pop    %edi
    38ee:	5d                   	pop    %ebp
    38ef:	c3                   	ret    
    38f0:	8b 75 d0             	mov    -0x30(%ebp),%esi
    38f3:	eb ee                	jmp    38e3 <printint+0x79>
...
printf(int fd, const char *fmt, ...)
{
  ...
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
    38fe:	8d 45 10             	lea    0x10(%ebp),%eax
    3901:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  state = 0;
    3904:	be 00 00 00 00       	mov    $0x0,%esi
  for(i = 0; fmt[i]; i++){
    3909:	bb 00 00 00 00       	mov    $0x0,%ebx
    390e:	eb 14                	jmp    3924 <printf+0x2f>
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
        ...
        putc(fd, c);
    3910:	89 fa                	mov    %edi,%edx
    3912:	8b 45 08             	mov    0x8(%ebp),%eax
    3915:	e8 36 ff ff ff       	call   3850 <putc>
    391a:	eb 05                	jmp    3921 <printf+0x2c>
      }
    } else if(state == '%'){
    391c:	83 fe 25             	cmp    $0x25,%esi
    391f:	74 25                	je     3946 <printf+0x51>
  for(i = 0; fmt[i]; i++){
    3921:	83 c3 01             	add    $0x1,%ebx
    3924:	8b 45 0c             	mov    0xc(%ebp),%eax
    3927:	0f b6 04 18          	movzbl (%eax,%ebx,1),%eax
    392b:	84 c0                	test   %al,%al
    392d:	0f 84 20 01 00 00    	je     3a53 <printf+0x15e>
    c = fmt[i] & 0xff;
    3933:	0f be f8             	movsbl %al,%edi
    3936:	0f b6 c0             	movzbl %al,%eax
    if(state == 0){
    3939:	85 f6                	test   %esi,%esi
    393b:	75 df                	jne    391c <printf+0x27>
      if(c == '%'){
    393d:	83 f8 25             	cmp    $0x25,%eax
    3940:	75 ce                	jne    3910 <printf+0x1b>
        state = '%';
    3942:	89 c6                	mov    %eax,%esi
    3944:	eb db                	jmp    3921 <printf+0x2c>
      if(c == 'd'){
    3946:	83 f8 25             	cmp    $0x25,%eax
    3949:	0f 84 cf 00 00 00    	je     3a1e <printf+0x129>
    394f:	0f 8c dd 00 00 00    	jl     3a32 <printf+0x13d>
    3955:	83 f8 78             	cmp    $0x78,%eax
    3958:	0f 8f d4 00 00 00    	jg     3a32 <printf+0x13d>
    395e:	83 f8 63             	cmp    $0x63,%eax
    3961:	0f 8c cb 00 00 00    	jl     3a32 <printf+0x13d>
    3967:	83 e8 63             	sub    $0x63,%eax
    396a:	83 f8 15             	cmp    $0x15,%eax
    396d:	0f 87 bf 00 00 00    	ja     3a32 <printf+0x13d>
    3973:	ff 24 85 44 53 00 00 	jmp    *0x5344(,%eax,4)
        printint(fd, *ap, 10, 1);
    397a:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    397d:	8b 17                	mov    (%edi),%edx
    397f:	83 ec 0c             	sub    $0xc,%esp
    3982:	6a 01                	push   $0x1
    3984:	b9 0a 00 00 00       	mov    $0xa,%ecx
    3989:	8b 45 08             	mov    0x8(%ebp),%eax
    398c:	e8 d9 fe ff ff       	call   386a <printint>
        ap++;
    3991:	83 c7 04             	add    $0x4,%edi
    3994:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    ...
    399f:	eb 80                	jmp    3921 <printf+0x2c>
        printint(fd, *ap, 16, 0);
    39a1:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    39a4:	8b 17                	mov    (%edi),%edx
    39a6:	83 ec 0c             	sub    $0xc,%esp
    39a9:	6a 00                	push   $0x0
    39ab:	b9 10 00 00 00       	mov    $0x10,%ecx
    39b0:	8b 45 08             	mov    0x8(%ebp),%eax
    39b3:	e8 b2 fe ff ff       	call   386a <printint>
        ap++;
    39b8:	83 c7 04             	add    $0x4,%edi
    39bb:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    39be:	83 c4 10             	add    $0x10,%esp
      state = 0;
    39c1:	be 00 00 00 00       	mov    $0x0,%esi
    39c6:	e9 56 ff ff ff       	jmp    3921 <printf+0x2c>
        s = (char*)*ap;
    39cb:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    39ce:	8b 30                	mov    (%eax),%esi
        ap++;
    39d0:	83 c0 04             	add    $0x4,%eax
    39d3:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
    39d6:	85 f6                	test   %esi,%esi
    39d8:	75 15                	jne    39ef <printf+0xfa>
          s = "(null)";
    39da:	be 3a 53 00 00       	mov    $0x533a,%esi
    39df:	eb 0e                	jmp    39ef <printf+0xfa>
          putc(fd, *s);
    39e1:	0f be d2             	movsbl %dl,%edx
    39e4:	8b 45 08             	mov    0x8(%ebp),%eax
    39e7:	e8 64 fe ff ff       	call   3850 <putc>
          s++;
    39ec:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
    39ef:	0f b6 16             	movzbl (%esi),%edx
    39f2:	84 d2                	test   %dl,%dl
    39f4:	75 eb                	jne    39e1 <printf+0xec>
      state = 0;
    39f6:	be 00 00 00 00       	mov    $0x0,%esi
    39fb:	e9 21 ff ff ff       	jmp    3921 <printf+0x2c>
        putc(fd, *ap);
    3a00:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    3a03:	0f be 17             	movsbl (%edi),%edx
    3a06:	8b 45 08             	mov    0x8(%ebp),%eax
    3a09:	e8 42 fe ff ff       	call   3850 <putc>
        ap++;
    3a0e:	83 c7 04             	add    $0x4,%edi
    3a11:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
    3a14:	be 00 00 00 00       	mov    $0x0,%esi
    3a19:	e9 03 ff ff ff       	jmp    3921 <printf+0x2c>
        putc(fd, c);
    3a1e:	89 fa                	mov    %edi,%edx
    3a20:	8b 45 08             	mov    0x8(%ebp),%eax
    3a23:	e8 28 fe ff ff       	call   3850 <putc>
      state = 0;
    3a28:	be 00 00 00 00       	mov    $0x0,%esi
    3a2d:	e9 ef fe ff ff       	jmp    3921 <printf+0x2c>
        putc(fd, '%');
    3a32:	ba 25 00 00 00       	mov    $0x25,%edx
    3a37:	8b 45 08             	mov    0x8(%ebp),%eax
    3a3a:	e8 11 fe ff ff       	call   3850 <putc>
        putc(fd, c);
    3a3f:	89 fa                	mov    %edi,%edx
    3a41:	8b 45 08             	mov    0x8(%ebp),%eax
    3a44:	e8 07 fe ff ff       	call   3850 <putc>
      state = 0;
    3a49:	be 00 00 00 00       	mov    $0x0,%esi
    3a4e:	e9 ce fe ff ff       	jmp    3921 <printf+0x2c>
    }
  }
}
...
{
    3a5b:	55                   	push   %ebp
    3a5c:	89 e5                	mov    %esp,%ebp
    3a5e:	57                   	push   %edi
    3a5f:	56                   	push   %esi
    3a60:	53                   	push   %ebx
    3a61:	8b 5d 08             	mov    0x8(%ebp),%ebx
  Header *bp, *p;

  bp = (Header*)ap - 1;
    3a64:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3a67:	a1 a0 a4 00 00       	mov    0xa4a0,%eax
    3a6c:	eb 02                	jmp    3a70 <free+0x15>
    3a6e:	89 d0                	mov    %edx,%eax
    3a70:	39 c8                	cmp    %ecx,%eax
    3a72:	73 04                	jae    3a78 <free+0x1d>
    3a74:	39 08                	cmp    %ecx,(%eax)
    3a76:	77 12                	ja     3a8a <free+0x2f>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3a78:	8b 10                	mov    (%eax),%edx
    3a7a:	39 c2                	cmp    %eax,%edx
    3a7c:	77 f0                	ja     3a6e <free+0x13>
    3a7e:	39 c8                	cmp    %ecx,%eax
    3a80:	72 08                	jb     3a8a <free+0x2f>
    3a82:	39 ca                	cmp    %ecx,%edx
    3a84:	77 04                	ja     3a8a <free+0x2f>
    3a86:	89 d0                	mov    %edx,%eax
    3a88:	eb e6                	jmp    3a70 <free+0x15>
      break;
  if(bp + bp->s.size == p->s.ptr){
    3a8a:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3a8d:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3a90:	8b 10                	mov    (%eax),%edx
    3a92:	39 d7                	cmp    %edx,%edi
    3a94:	74 19                	je     3aaf <free+0x54>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
    3a96:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    3a99:	8b 50 04             	mov    0x4(%eax),%edx
    3a9c:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    3a9f:	39 ce                	cmp    %ecx,%esi
    3aa1:	74 1b                	je     3abe <free+0x63>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    3aa3:	89 08                	mov    %ecx,(%eax)
  freep = p;
    3aa5:	a3 a0 a4 00 00       	mov    %eax,0xa4a0
}
    3aaa:	5b                   	pop    %ebx
    3aab:	5e                   	pop    %esi
    3aac:	5f                   	pop    %edi
    ...
    3aae:	c3                   	ret    
    bp->s.size += p->s.ptr->s.size;
    3aaf:	03 72 04             	add    0x4(%edx),%esi
    3ab2:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    3ab5:	8b 10                	mov    (%eax),%edx
    3ab7:	8b 12                	mov    (%edx),%edx
    3ab9:	89 53 f8             	mov    %edx,-0x8(%ebx)
    3abc:	eb db                	jmp    3a99 <free+0x3e>
    p->s.size += bp->s.size;
    3abe:	03 53 fc             	add    -0x4(%ebx),%edx
    3ac1:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    3ac4:	8b 53 f8             	mov    -0x8(%ebx),%edx
    3ac7:	89 10                	mov    %edx,(%eax)
    3ac9:	eb da                	jmp    3aa5 <free+0x4a>
...
{
    3acb:	55                   	push   %ebp
    3acc:	89 e5                	mov    %esp,%ebp
    3ace:	53                   	push   %ebx
    3acf:	83 ec 04             	sub    $0x4,%esp
    3ad2:	89 c3                	mov    %eax,%ebx
  char *p;
  Header *hp;

  if(nu < 4096)
    3ad4:	3d ff 0f 00 00       	cmp    $0xfff,%eax
    3ad9:	77 05                	ja     3ae0 <morecore+0x15>
    nu = 4096;
    3adb:	bb 00 10 00 00       	mov    $0x1000,%ebx
  p = sbrk(nu * sizeof(Header));
    3ae0:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    3ae7:	83 ec 0c             	sub    $0xc,%esp
    3aea:	50                   	push   %eax
    3aeb:	e8 38 fd ff ff       	call   3828 <sbrk>
  if(p == (char*)-1)
    3af0:	83 c4 10             	add    $0x10,%esp
    3af3:	83 f8 ff             	cmp    $0xffffffff,%eax
    3af6:	74 1c                	je     3b14 <morecore+0x49>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
  ...
  free((void*)(hp + 1));
    ...
    3b01:	50                   	push   %eax
    3b02:	e8 54 ff ff ff       	call   3a5b <free>
  return freep;
    3b07:	a1 a0 a4 00 00       	mov    0xa4a0,%eax
    3b0c:	83 c4 10             	add    $0x10,%esp
}
    3b0f:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3b12:	c9                   	leave  
    3b13:	c3                   	ret    
    return 0;
    3b14:	b8 00 00 00 00       	mov    $0x0,%eax
    3b19:	eb f4                	jmp    3b0f <morecore+0x44>
...
{
    3b1b:	55                   	push   %ebp
    3b1c:	89 e5                	mov    %esp,%ebp
    3b1e:	53                   	push   %ebx
    3b1f:	83 ec 04             	sub    $0x4,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    3b22:	8b 45 08             	mov    0x8(%ebp),%eax
    3b25:	8d 58 07             	lea    0x7(%eax),%ebx
    3b28:	c1 eb 03             	shr    $0x3,%ebx
    3b2b:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
    3b2e:	8b 0d a0 a4 00 00    	mov    0xa4a0,%ecx
    3b34:	85 c9                	test   %ecx,%ecx
    3b36:	74 04                	je     3b3c <malloc+0x21>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3b38:	8b 01                	mov    (%ecx),%eax
    3b3a:	eb 4a                	jmp    3b86 <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
    3b3c:	c7 05 a0 a4 00 00 a4 	movl   $0xa4a4,0xa4a0
    3b43:	a4 00 00 
    3b46:	c7 05 a4 a4 00 00 a4 	movl   $0xa4a4,0xa4a4
    3b4d:	a4 00 00 
    base.s.size = 0;
    3b50:	c7 05 a8 a4 00 00 00 	movl   $0x0,0xa4a8
    3b57:	00 00 00 
    base.s.ptr = freep = prevp = &base;
    3b5a:	b9 a4 a4 00 00       	mov    $0xa4a4,%ecx
    3b5f:	eb d7                	jmp    3b38 <malloc+0x1d>
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
    3b61:	74 19                	je     3b7c <malloc+0x61>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
    3b63:	29 da                	sub    %ebx,%edx
    3b65:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    3b68:	8d 04 d0             	lea    (%eax,%edx,8),%eax
        p->s.size = nunits;
    3b6b:	89 58 04             	mov    %ebx,0x4(%eax)
      }
      freep = prevp;
    3b6e:	89 0d a0 a4 00 00    	mov    %ecx,0xa4a0
      return (void*)(p + 1);
    3b74:	83 c0 08             	add    $0x8,%eax
    }
    if(p == freep)
    ...
    3b77:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3b7a:	c9                   	leave  
    3b7b:	c3                   	ret    
        prevp->s.ptr = p->s.ptr;
    3b7c:	8b 10                	mov    (%eax),%edx
    3b7e:	89 11                	mov    %edx,(%ecx)
    3b80:	eb ec                	jmp    3b6e <malloc+0x53>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3b82:	89 c1                	mov    %eax,%ecx
    3b84:	8b 00                	mov    (%eax),%eax
    if(p->s.size >= nunits){
    3b86:	8b 50 04             	mov    0x4(%eax),%edx
    3b89:	39 da                	cmp    %ebx,%edx
    3b8b:	73 d4                	jae    3b61 <malloc+0x46>
    if(p == freep)
    3b8d:	39 05 a0 a4 00 00    	cmp    %eax,0xa4a0
    3b93:	75 ed                	jne    3b82 <malloc+0x67>
      if((p = morecore(nunits)) == 0)
    3b95:	89 d8                	mov    %ebx,%eax
    3b97:	e8 2f ff ff ff       	call   3acb <morecore>
    3b9c:	85 c0                	test   %eax,%eax
    3b9e:	75 e2                	jne    3b82 <malloc+0x67>
    3ba0:	eb d5                	jmp    3b77 <malloc+0x5c>
